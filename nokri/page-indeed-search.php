...
$job_title       = isset($_GET['job-title']) ? sanitize_text_field($_GET['job-title']) : 'web developer';
$job_country     = isset($_GET['con']) ? sanitize_text_field($_GET['con']) : '';
$job_loc         = isset($_GET['job-loc']) ? sanitize_text_field($_GET['job-loc']) : '';
$job_type        = isset($_GET['jt']) ? sanitize_text_field($_GET['jt']) : '';
$sort_by         = isset($_GET['order_job']) ? sanitize_text_field($_GET['order_job']) : 'date';
$jobs_num        = isset($_GET['jn']) ? sanitize_text_field($_GET['jn']) : '25';
$job_expiry      = isset($_GET['jd']) ? sanitize_text_field($_GET['jd']) : '';
$jobs_by         = isset($_GET['jb']) ? sanitize_text_field($_GET['jb']) : '';
$fromage         = isset($_GET['frm']) ? sanitize_text_field($_GET['frm']) : '';
...
$request = wp_remote_get(esc_url($final_url));
...
$country_array = array();
$country_array = array(
    "Argentina" => "ar", "Australia" => "au", "Austria" => "at", "Bahrain" => "h", "Belgium" => "be", "Brazil" => "br",
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 ">
                        <aside class="new-sidebar">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading tab-collapsed " role="tab">
                                        <a role="button" data-bs-toggle="collapse" href="#job_keyword" aria-expanded="true" class="">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading tab-collapsed " role="tab">
                                        <a role="button" data-bs-toggle="collapse" href="#job_country" aria-expanded="true" class="">
                                    ...
                                    <div id="job_country" class="panel-collapse collapse in" role="tabpanel" aria-expanded="true" style="">
                                        <div class="panel-body">
                                            <form method="GET" id="job_order_search">
                                                <div class="form-group">
                                                    <select class="js-example-basic-single form-control " data-allow-clear="true" data-placeholder="<?php echo esc_attr__("Select Option", "nokri"); ?>" style="width: 100%" name="con" id="con">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading tab-collapsed " role="tab">
                                        <a role="button" data-bs-toggle="collapse" href="#job_loc" aria-expanded="true" class="">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading tab-collapsed " role="tab">
                                        <a role="button" data-bs-toggle="collapse" href="#job_type" aria-expanded="true" class="">
                                    ...
                                    <div id="job_type" class="panel-collapse collapse in" role="tabpanel" aria-expanded="true" style="">
                                        <div class="panel-body">
                                            <form method="GET" id="job_order_search">
                                                <div class="form-group">
                                                    <select class="js-example-basic-single form-control " data-allow-clear="true" data-placeholder="<?php echo esc_attr__("Select Option", "nokri"); ?>" style="width: 100%" name="jt" id="jt">
                            ...
                            <?php if ($jobs_number_switch) { ?>
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading tab-collapsed " role="tab">
                                            <a role="button" data-bs-toggle="collapse" href="#job_from" aria-expanded="true" class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <form method="GET" id="emp_active_job">
                                            <select class="js-example-basic-single form-control emp_active_job" data-allow-clear="true" data-placeholder="<?php echo esc_attr__("Select Option", "nokri"); ?>" style="width: 100%" name="order_job" id="order_job">
