        ...
        if ($is_elementor_header == false) {
            ...
            <?php if (!( function_exists('has_site_icon') && has_site_icon() )) { ?>
                <link rel="shortcut icon" href="
                      <?php echo esc_url(get_template_directory_uri() . '/images/favicon.ico'); ?>" type="image/x-icon">
                      <?php
                  }
                  wp_head();
                  ?>
                <script type="text/javascript" src="<?php echo esc_url('https://www.google.com/jsapi'); ?>"></script>
        </head>
        <body <?php body_class(); ?>>
            <?php
            wp_body_open();
            ...
            if ((isset($nokri['loader_img_switch'])) && $nokri['loader_img_switch'] == 1) {
                ...
                ?>
                <div id="spinner">
                    <div class="spinner-img"><img alt="<?php echo esc_attr__('Preloader', 'nokri'); ?>" src="<?php echo esc_url($preldr_link[0]); ?>"/>
                        <h2><?php echo ''.esc_html($loader_text ); ?></h2>
                    </div>
                </div>
                <?php
            }
