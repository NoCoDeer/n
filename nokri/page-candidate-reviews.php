...
$author_id = isset($_GET['user_id']) ? $_GET['user_id'] : 0;

// Sanitize and validate user_id
$author_id = filter_var($author_id, FILTER_SANITIZE_NUMBER_INT);  // Remove any non-numeric characters
$author_id = intval($author_id);  // Ensure it is an integer

// Check if the ID is a valid number and greater than 0
if ($author_id <= 0) {
    die(); // You could also redirect or show a proper error message.
}
                                        ...
                                        <div class="profile-meta">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <?php echo esc_html(date("F j, Y", strtotime($author_detail->user_registered))); ?>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
