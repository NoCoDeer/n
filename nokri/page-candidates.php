...
if (post_password_required()) {
    ...
    if (isset($nokri['cand_search_mode']) && $nokri['cand_search_mode'] == "2") {
        if (!is_user_logged_in()) {
            echo nokri_redirect(esc_url(get_the_permalink($signin_page)));
        }
    }
    /* search section bg */
    $list_bg_url = '';
    ...
    if (isset($_GET['cand_level']) && $_GET['cand_level'] != "") {
        $level = sanitize_text_field(_GET['cand_level']);
    }
    $skills = '';
    if (isset($_GET['cand_skills']) && $_GET['cand_skills'] != "") {
        $skills = sanitize_text_field($_GET['cand_skills']);
    }
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <aside class="new-sidebar candidate-sidebar  <?php echo esc_attr($show_mob_filter) ? 'mobile-filters' : ''; ?>">
                                <div class="heading">
                                    <h4> <?php echo esc_html__("Search Filters", 'nokri'); ?></h4>
                                    <a href="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>"><?php echo esc_html__("Clear All", 'nokri'); ?></a>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <form method="GET" id="candiate_order">
                                                <select class="js-example-basic-single form-control candidates_orders" data-allow-clear="true" data-placeholder="<?php echo esc_attr__("Select option", 'nokri'); ?>" style="width: 100%" name="order">
