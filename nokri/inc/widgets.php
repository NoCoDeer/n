    ...
    class nokri_search_job extends WP_Widget
    {
        ...
        function __construct()
        {
            parent::__construct(
                'nokri_search_job',
                // Base ID
                esc_html__('Nokri search by keyword', 'nokri'),
                // Name
                array(
                    'description' => esc_html__('Show Search Box', 'nokri'),
                ) // Args
            );
        }
...
?>
            <div class="accordion" id="searchWidgetAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSearchWidget abc">
                        <button class="accordion-button <?php echo esc_attr($collapsed ? 'collapsed' : ''); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#search-widget" aria-expanded="true" aria-controls="search-widget">
                            <?php echo nokri_returnEcho($instance['title']); ?>
                            <span class="icon ms-auto">
                                <i class="fa <?php echo esc_attr(empty($collapsed) ? 'fa-minus' : 'fa-plus'); ?>"></i>
                            </span>
                        </button>
                    </h2>
                    <div id="search-widget" class="accordion-collapse collapse <?php echo esc_attr($in ? 'show' : ''); ?>" aria-labelledby="headingSearchWidget" data-bs-parent="#searchWidgetAccordion">
                        <div class="accordion-body">
                            <form role="search" method="get" action="<?php echo esc_url(get_the_permalink($nokri['sb_search_page'])); ?>">
                                <div class="input-group">
                                    <input type="text" class="form-control" value="<?php echo esc_attr($title); ?>" name="job-title" placeholder="<?php echo esc_attr__('Search Here', 'nokri') ?>">
        ...
        ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'nokri'); ?></label>
...
class nokri_search_categories extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_categories',
            // Base ID
            esc_html__('Nokri Search Categories', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show All Job Categories', 'nokri'),
            ) // Args
        );
    }
                ...
                <div class="accordion" id="jobCategoryAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingJobCategory">
                            <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-job_category" aria-expanded="true" aria-controls="collapse-job_category">
                                <?php
                        ...
                        <div id="collapse-job_category" class="accordion-collapse collapse <?php echo esc_attr($in ? 'show' : ''); ?>" aria-labelledby="headingJobCategory" data-bs-parent="#jobCategoryAccordion">
                            <div class="accordion-body">
                                <?php
                                if (isset($_GET['cat-id']) && $_GET['cat-id'] != "") {
                                ?>
                                    <!--<div class="cat_head">
                                            <span><?php // echo nokri_get_taxonomy_parents($_GET['cat-id'], 'job_category', false); 
                                                    ?></span>
                                        </div> -->
                                <?php
                                }
                                ?>
                                <form method="get" id="search_form" action="<?php echo esc_url(get_the_permalink($nokri['sb_search_page'])); ?>">
                                    <div class="cp-loader"></div>
                                    <div class="form-group">
                                        <select class="questions-category form-control" data-parsley-required="true" id="make_id">
                                            <?php echo nokri_returnEcho($cats_html); ?>
                                        </select>
                                    </div>
                                    ...
                                    <input type="button" class="btn n-btn-flat btn-mid wd-btn" id="category_search" value="<?php echo esc_attr__('Search', 'nokri'); ?>">
...
class nokri_custom_search_widget extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_custom_search_widget',
            // Base ID
            esc_html__('Custom Search', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show Custom Search', 'nokri'),
            ) // Args
        );
    }
    ...
    ?>
        <div class="panel panel-default">
            <div class="panel-heading active" role="tab">
                <a role="button" data-bs-toggle="collapse" href="#collapse-custom_category">
                    <?php
                    if (!empty($instance['title'])) {
                        echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                    }
...
class nokri_radius_search extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'nokri_radius_search',
            // Base ID
            esc_html__('Nokri Radius Search', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Compatible only with map search page', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (isset($_GET['sb_user_address'])) {
            $adress = sanitize_text_field($_GET['sb_user_address']);
        }
    ?>
        <div class="panel panel-default">
            <div class="panel-heading <?php echo esc_attr(($collapse == 'true') ? 'active' : ''); ?>" role="tab">
                <a role="button" data-bs-toggle="collapse" href="#radius_search" class="<?php echo esc_attr(($collapse == 'true') ? '' : 'collapsed'); ?>">
                    <?php echo nokri_returnEcho($instance['title']); ?>
                </a>
            </div>
            <div id="radius_search" class="panel-collapse collapse <?php echo esc_attr(($collapse == 'true') ? 'show' : ''); ?>" role="tabpanel">
                <div class="panel-body">
                    <form role="search" method="get" action="<?php echo esc_url(get_the_permalink($nokri['sb_search_page'])); ?>" class="custom-search-form">
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo esc_attr($adress); ?>" name="sb_user_address" id="sb_user_address" placeholder="<?php echo esc_attr__('Enter Map Address', 'nokri') ?>">
                            <a href="javascript:void(0);" id="your_current_location_alert" title="<?php echo esc_attr__('You Current Location', 'nokri'); ?>"><i class="fa fa-crosshairs"></i></a>
                            <input type="Number" class="form-control" value="<?php echo esc_attr($distance); ?>" name="distance" placeholder="<?php echo esc_attr__('Number of miles', 'nokri') ?>">
    ...
    class nokri_search_widget extends WP_Widget
    {
        ...
        function __construct()
        {
            parent::__construct(
                'nokri_search_widget',
                // Base ID
                esc_html__('Nokri All Search Widget', 'nokri'),
                // Name
                array(
                    'description' => esc_html__('Add All Search Widget', 'nokri'),
                ) // Args
            );
        }
        ...
        ?>
                ...
                <select name="<?php echo esc_attr($this->get_field_name('taxonomy_list')); ?>" id="<?php echo esc_attr($this->get_field_id('taxonomy_list')); ?>" class="widefat">
                    ...
                    if (count($customPostTaxonomies) > 0) {
                        foreach ($customPostTaxonomies as $tax) {
                            ...
                            echo '<option value="' . esc_attr($tax->name) . '" ' . $selected . '>' . esc_html($tax->labels->singular_name) . '</option>';
                        }
                    }
                    ?>
                </select>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>"><?php
                                                                                            esc_attr_e(
                                                                                                'By Default Number of Records:',
                                                                                                'nokri'
                                                                                            );
                                                                                            ?></label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>" name="<?php
                                                                                                                echo esc_attr($this->get_field_name('no_of_records')); ?>" type="number" value="<?php echo esc_attr($no_of_records); ?>">
            </p>
...
class nokri_search_location extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_location',
            // Base ID
            esc_html__('Nokri Custom Locations', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show All Job Locations', 'nokri'),
            ) // Args
        );
    }
            ...
            <div class="accordion" id="locationSearchAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingLocationSearch">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#location_search" aria-expanded="<?php echo esc_attr(empty($collapsed) ? 'true' : 'false'); ?>" aria-controls="location_search">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="location_search" class="accordion-collapse collapse <?php echo esc_attr(empty($collapsed) ? 'show' : ''); ?>" aria-labelledby="headingLocationSearch" data-bs-parent="#locationSearchAccordion">
                        <div class="accordion-body">
                            <?php
                            ...
                            ?>
                            <form method="get" id="search_form" action="<?php echo esc_url($form_for); ?>">
                                <div class="cp-loader"></div>
                                <div class="mb-2">
                                ...
                                <button type="button" class="btn n-btn-flat btn-mid location_search wd-btn" id="location_search_btn"><?php echo esc_html__('Search', 'nokri'); ?></button>
...
class nokri_search_candidate extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate',
            // Base ID
            esc_html__('Candidate Title', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Get candidate by title', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (isset($_GET['cand_title']) && $_GET['cand_title'] != "") {
            $title = sanitize_text_field($_GET['cand_title']);
            $in = 'in';
        }
    ?>
        <div class="accordion" id="searchAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSearchWidget">
                    <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#search-widget" aria-expanded="true" aria-controls="search-widget">
                        <?php echo nokri_returnEcho($instance['title']); ?>
                        <span class="icon">
                            <i class="fa <?php echo esc_attr(($collapsed == 'true') ? 'fa-minus' : 'fa-plus'); ?>"></i>
                        </span>
                    </button>
                </h2>
                <!-- Set the class to "show" to keep the accordion open by default -->
                <div id="search-widget" class="accordion-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" aria-labelledby="headingSearchWidget" data-bs-parent="#searchAccordion">
                    <div class="accordion-body">
                        <form role="search" method="get" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo esc_attr($title); ?>" name="cand_title" placeholder="<?php echo esc_attr__('Search Here', 'nokri') ?>">
                            </div>
                            <div class="form-group form-action">
...
class nokri_search_candidate_headline extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_headline',
            // Base ID
            esc_html__('Candidate Headline', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Get candidate by headline', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (isset($_GET['cand-headline']) && $_GET['cand-headline'] != "") {
            $title = sanitize_text_field($_GET['cand-headline']);
            $in = 'in';
        }
    ?>
        <div class="accordion" id="searchAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSearch">
                    <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#search-headline" aria-expanded="true" aria-controls="search-headline">
                        <?php echo nokri_returnEcho($instance['title']); ?>
                        <span class="icon">
                            <i class="fa <?php echo esc_attr(($collapsed == 'true') ? 'fa-minus' : 'fa-plus'); ?>"></i>
                        </span>
                ...
                <!-- Add "show" class to keep the accordion open initially -->
                <div id="search-headline" class="accordion-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" aria-labelledby="headingSearch" data-bs-parent="#searchAccordion">
                    <div class="accordion-body">
                        <form role="search" class="custom-search-form" method="get" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?php echo esc_attr($title); ?>" name="cand-headline" placeholder="<?php echo esc_attr__('e.g Developer...', 'nokri') ?>">
                                <button type="submit" class="btn n-btn-flat btn-mid">
...
class nokri_search_candidate_type extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_type',
            // Base ID
            esc_html__('Candidate Type', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show All candidate type', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (count((array) $search_types) > 0) {
            ...
            foreach ($search_types as $search_type) {
                ...
                if ($showed) {
                    $showed = false;
                    $type_html .= '<li class="text-center show-more hide_now_' . esc_attr($cur_cls) . '"><small><a href="javascript:void(0);" class="show_records" data-attr-id="hide_type" data-attr-hide="' . esc_attr($cur_cls) . '">' . __('Show more', 'nokri') . '</a></small></li>';
                }
        ...
        ?>
            <div class="accordion" id="candJobTypeAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobType">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_type" aria-expanded="<?php echo esc_attr($collapsed); ?>" aria-controls="cand_job_type">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_type" class="accordion-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" aria-labelledby="headingCandJobType" data-bs-parent="#candJobTypeAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_type_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo nokri_returnEcho($type_html); ?>
                                </ul>
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>"><?php
                                                                                        ...
                                                                                        ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>" name="<?php
                                                                                                            echo esc_attr($this->get_field_name('no_of_records'));
...
class nokri_search_candidate_skills extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_skills',
            // Base ID
            esc_html__('Search by candidate skills', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidate by skills', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        ?>
            <div class="panel panel-default">
                <div class="panel-heading active" role="tab">
                    <a role="button" class="<?php echo esc_attr($collapsed); ?>" data-bs-toggle="collapse" href="#cand_job_skills">
                        <?php echo "" . $instance['title']; ?>
                    </a>
                </div>
                <div id="cand_job_skills" class="panel-collapse collapse <?php echo esc_attr($in); ?>" role="tabpanel">
                    <form method="get" id="cand_skills_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                        <div class="panel-body">
                            <ul class="list">
                                <?php echo "" . ($skill_html); ?>
                            </ul>
...
class nokri_search_candidate_level extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_level',
            // Base ID
            esc_html__('Candidate Level', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidates by level', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (count((array) $search_types) > 0) {
            ...
            foreach ($search_types as $search_type) {
                ...
                $type_html .= '<li class="mb-2 ' . esc_attr($cls) . '"><input class="input-icheck input-icheck-search cand_level_form" ' . esc_attr($selected) . ' value="' . esc_attr($search_type->term_id) . '" type="radio"  name="cand_level"> <label>' . esc_html($search_type->name) . '</label></li>';
                $count++;
            }
            global $nokri;
            $in = 'collapsed';
            ...
            <div class="accordion" id="candJobLevelAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobLevel">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_level" aria-expanded="true" aria-controls="cand_job_level">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_level" class="accordion-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" aria-labelledby="headingCandJobLevel" data-bs-parent="#candJobLevelAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_level_form" class="search_candidates_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo "" . ($type_html); ?>
                                </ul>
...
class nokri_search_candidate_experience extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_experience',
            // Base ID
            esc_html__('Candidate Experience', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidates by experience', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (count((array) $search_types) > 0) {
            ...
            foreach ($search_types as $search_type) {
                ...
                if ($showed) {
                    $showed = false;
                    $type_html .= '<li class="text-center show-more show-more hide_now_' . esc_attr($cur_cls) . '"><small><a href="javascript:void(0);" class="show_records" data-attr-id="hide_experience" data-attr-hide="' . esc_attr($cur_cls) . '">' . __('Show more', 'nokri') . '</a></small></li>';
                }


                $type_html .= '<li class="' . esc_attr($cls) . ' mb-2"><input class="input-icheck input-icheck-search cand_experience_form" ' . esc_attr($selected) . ' value="' . esc_attr($search_type->term_id) . '" type="radio"  name="cand_experience"> <label>' . esc_html($search_type->name) . '</label></li>';
                $count++;
            }
            global $nokri;
            $in = 'collapsed';
            $collapsed = 'false';
            $collapsedin = 'collapsed';
            $collapse = '';
            $is_show = '';
            if (isset($instance['is_open']) && $instance['is_open'] == 'open') {
                $in = 'in';
        ...
        ?>
            <div class="accordion" id="candJobExperienceAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobLevel">
                        <button class="accordion-button <?php echo esc_attr($collapsedin); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_experience" aria-expanded="<?php echo esc_attr($collapsed); ?>" aria-controls="cand_job_level">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_experience" class="accordion-collapse collapse <?php echo esc_attr($in) . ' ' . esc_attr($collapse) . ' ' . esc_attr($is_show); ?>" aria-labelledby="headingCandJobLevel" data-bs-parent="#candJobExperienceAccordion">

                        <div class="accordion-body">
                            <form method="get" id="cand_experience_form" class="search_candidates_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo "" . ($type_html); ?>
                                </ul>
...
class nokri_search_candidate_qualification extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_qualification',
            // Base ID
            esc_html__('Candidate Qualifications', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidates by qualification', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        ?>
            <div class="panel panel-default">
                <div class="panel-heading active" role="tab">
                    <a role="button" class="<?php echo esc_attr($collapsed); ?>" data-bs-toggle="collapse" href="#cand_job_qualification">
                        <?php
                        if (!empty($instance['title'])) {
                            echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                        }
                ...
                <div id="cand_job_qualification" class="panel-collapse collapse <?php echo esc_attr($in); ?>" role="tabpanel">
                    <form method="get" id="cand_quali_form" class="search_candidates_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                        <div class="panel-body">
                            <ul class="list">
                                <?php echo "" . ($type_html); ?>
                            </ul>
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>"><?php
                                                                                        esc_attr_e('By Default Number of Records:', 'nokri');
                                                                                        ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('no_of_records')); ?>" name="<?php
                                                                                                            echo esc_attr($this->get_field_name('no_of_records')); ?>" type="number" value="<?php echo esc_attr($no_of_records); ?>">
        </p>
...
class nokri_search_candidate_gender extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_gender',
            // Base ID
            esc_html__('Candidate Gender', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidates by gender', 'nokri'),
            ) // Args
        );
    }
            ...
            <div class="accordion" id="candGenderAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandGender">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_gender" aria-expanded="<?php echo esc_attr(empty($collapsed) ? 'true' : 'false'); ?>" aria-controls="cand_gender">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                            ?>
                            <span class="icon">
                                <i class="fa <?php echo esc_attr(empty($in) ? 'fa-plus' : 'fa-minus'); ?>"></i>
                            </span>
                        </button>
                    </h2>
                    <div id="cand_gender" class="accordion-collapse collapse <?php echo esc_attr(empty($collapsed) ? 'show' : ''); ?>" aria-labelledby="headingCandGender" data-bs-parent="#candGenderAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_gender_form" class="search_candidates_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo nokri_returnEcho($type_html); ?>
                                </ul>
...
class nokri_search_candidate_salary1 extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_salary1',
            // Base ID
            esc_html__('Candidate Salary Range', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidate by salary', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        ?>
            <div class="accordion" id="candJobSalaryAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobSalary">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_salary" aria-expanded="<?php echo esc_attr(empty($collapsed) ? 'true' : 'false'); ?>" aria-controls="cand_job_salary">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_salary" class="accordion-collapse collapse <?php echo esc_attr(empty($collapsed) ? 'show' : ''); ?>" aria-labelledby="headingCandJobSalary" data-bs-parent="#candJobSalaryAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_job_salary_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo nokri_returnEcho($salary_html); ?>
                                </ul>
...
class nokri_search_candidate_salary_type extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_salary_type',
            // Base ID
            esc_html__('Candidate Salary Type', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidate by salary', 'nokri'),
            ) // Args
    ...
    public function widget($args, $instance)
    {
        ...
        if (count((array) $search_types) > 0) {
            ...
            foreach ($search_types as $search_type) {
                ...
                if ($showed) {
                    $showed = false;
                    $salary_html .= '<li class="text-center show-more hide_now_' . esc_attr($cur_cls) . '"><small><a href="javascript:void(0);" class="show_records" data-attr-id="hide_salary_type" data-attr-hide="' . esc_attr($cur_cls) . '">' . __('Show more', 'nokri') . '</a></small></li>';
                }
        ...
        ?>
            <div class="accordion" id="candJobSalaryTypeAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobSalaryType">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_salary_type" aria-expanded="<?php echo esc_attr(empty($collapsed) ? 'true' : 'false'); ?>" aria-controls="cand_job_salary_type">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_salary_type" class="accordion-collapse collapse <?php echo esc_attr(empty($collapsed) ? 'show' : ''); ?>" aria-labelledby="headingCandJobSalaryType" data-bs-parent="#candJobSalaryTypeAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_job_salary_type_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo nokri_returnEcho($salary_html); ?>
                                </ul>
...
class nokri_search_candidate_salary_currency extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_candidate_salary_currency',
            // Base ID
            esc_html__('Candidate Salary Currency', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show candidate by salary currency', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (count((array) $search_types) > 0) {
            ...
            foreach ($search_types as $search_type) {
                ...
                if ($showed) {
                    $showed = false;
                    $salary_html .= '<li class="text-center show-more hide_now_' . esc_attr($cur_cls) . '"><small><a href="javascript:void(0);" class="show_records" data-attr-id="hide_salary_currency" data-attr-hide="' . esc_attr($cur_cls) . '">' . __('Show more', 'nokri') . '</a></small></li>';
                }
        ...
        ?>
            <div class="accordion" id="candJobSalaryCurrencyAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingCandJobSalaryCurrency">
                        <button class="accordion-button <?php echo esc_attr(empty($collapsed) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#cand_job_salary_currency" aria-expanded="<?php echo esc_attr(empty($collapsed) ? 'true' : 'false'); ?>" aria-controls="cand_job_salary_currency">
                            <?php
                            if (!empty($instance['title'])) {
                                echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                            }
                    ...
                    <div id="cand_job_salary_currency" class="accordion-collapse collapse <?php echo esc_attr(empty($collapsed) ? 'show' : ''); ?>" aria-labelledby="headingCandJobSalaryCurrency" data-bs-parent="#candJobSalaryCurrencyAccordion">
                        <div class="accordion-body">
                            <form method="get" id="cand_salary_form" action="<?php echo esc_url(get_the_permalink($nokri['candidates_search_page'])); ?>">
                                <ul class="list-unstyled">
                                    <?php echo nokri_returnEcho($salary_html); ?>
                                </ul>
...
class nokri_search_employer_skills extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_employer_skills',
            // Base ID
            esc_html__('Employer Specialization', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show employer by specialization', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        ?>
            <div class="panel panel-default">
                <div class="panel-heading emp_spec_wed <?php esc_attr(($collapsed == 'true') ? 'active' : ''); ?>" role="tab">
                    <a class="<?php echo esc_attr(($collapsed == 'true') ? '' : 'collapsed'); ?>" role="button" data-bs-toggle="collapse" href="#emp_job_skills">
                        <?php
                        if (!empty($instance['title'])) {
                            echo nokri_returnEcho($args['before_title'] . apply_filters('widget_title', $instance['title']) . $args['after_title']);
                        }
                ...
                <div id="emp_job_skills" class="panel-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" role="tabpanel">
                    <form method="get" id="emp_job_skills" action="<?php echo esc_url(get_the_permalink($nokri['employer_search_page'])); ?>">
                        <div class="panel-body">
                            <ul class="list">
                                <?php echo "" . ($skill_html); ?>
                            </ul>
...
class nokri_search_blogs extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'nokri_search',
            // Base ID
            esc_html__('blog posts Search', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show Search Box', 'nokri'),
            ) // Args
        ...
        <div class="search-blog">
            <form role="search" method="get" id="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                <div class="input-group stylish-input-group">
                    <input class="form-control" type="text" value="<?php the_search_query(); ?>" name="s" id="s" placeholder="<?php echo esc_attr__('Search here', 'nokri'); ?>">
...
class nokri_popular_posts extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'nokri_popular_posts',
            // Base ID
            esc_html__('Recent Blog posts ', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show Your Blog Posts ', 'nokri'),
            ) // Args
        );
    }
            ...
            ?>
                <li> <?php if (has_post_thumbnail()) { ?>
                    ...
                    <div class="recent-ads-list-content">
                        <a href="<?php esc_url(the_permalink()); ?>"><?php echo esc_html(wp_trim_words(get_the_title(), 7, '...')); ?></a>
...
class nokri_search_employer extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_search_employer',
            // Base ID
            esc_html__('Employer Title', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Get employer by title', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (isset($_GET['emp_title']) && $_GET['emp_title'] != "") {
            $title = sanitize_text_field($_GET['emp_title']);
            $in = 'in';
        }
        ?>
        <div class="accordion" id="searchWidgetAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSearchWidget">
                    <button class="accordion-button <?php echo esc_attr(empty($in) ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#search-widget" aria-expanded="true" aria-controls="search-widget">
                        <?php echo nokri_returnEcho($instance['title']); ?>
                        <span class="icon">
                            <i class="fa <?php echo esc_attr(($collapsed == 'true') ? 'fa-minus' : 'fa-plus'); ?>"></i>
                        </span>
                ...
                <div id="search-widget" class="accordion-collapse collapse <?php echo esc_attr(($collapsed == 'true') ? 'show' : ''); ?>" aria-labelledby="headingSearchWidget" data-bs-parent="#searchWidgetAccordion">
                    <div class="accordion-body">
                        <form role="search" method="get" action="<?php echo esc_url(get_the_permalink($nokri['employer_search_page'])); ?>">
                            <div class="mb-3">
                                <input type="text" class="form-control" value="<?php echo esc_attr($title); ?>" name="emp_title" placeholder="<?php echo esc_attr__('Search Here', 'nokri') ?>">
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary border-0"><i class="fa fa-search"></i></button>
                            </div>
...
if (!class_exists('Advertisementwidget_Widget')) {
    ...
    class Advertisementwidget_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'advertisementwidget_widget',
                // Base ID
                esc_html__('Advertisement Widget', 'nokri'),
                array(
                    'description' => esc_html__('Get Advertisement Widget', 'nokri'),
                ) // Args
            );
        }
        ...
        ?>
            <div class="panel panel-default">
                <div class="panel-heading active" role="tab">
                    <a role="button" data-bs-toggle="collapse" href="#advertisment-widget">
                        <?php echo nokri_returnEcho($instance['title']); ?>
                    </a>
                </div>
        ...
        ?>
            ...
            <!--Source image --->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('source_img')); ?>"><?php esc_html_e('Paste source:', 'nokri'); ?></label> <textarea rows="4" cols="50" id="<?php echo esc_attr($this->get_field_id('source_img')); ?>" name="<?php echo esc_attr($this->get_field_name('source_img')); ?>"><?php echo esc_html($source_img); ?></textarea>
            </p>
            <!--Open/Close  --->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('is_open')); ?>"><?php
                                ...
                                ?>
                                    <div class="recent-ads-list-image">
                                        <a href="#" class="recent-ads-list-image-inner">
                                            <img src="<?php echo esc_url($get_img_src[0]); ?>" alt="<?php echo "" . esc_attr((get_the_title($recent_post->ID))); ?>">
                                        </a>
                                    </div>
                                <?php endif; ?>
                                <div class="recent-ads-list-content">
                                    ...
                                    <ul class="recent-ads-list-location">
                                        ...
                                        ?>
                                        <li><a href="<?php echo esc_url(get_category_link($category[0]->cat_ID)); ?>"><?php echo '' . esc_html($category[0]->cat_name); ?></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
class nokri_job_keyword_new extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_job_keyword_new',
            // Base ID
            esc_html__('Nokri Jobs Search By Keyword', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Add widget for search jobs by keywords', 'nokri'),
            ) // Args
        );
    }
        ...
        <div class="panel panel-default">
            ...
            <div id="job_keyword" class="panel-collapse collapse <?php echo esc_attr($in); ?>" role="tabpanel">
                <div class="panel-body">
                    <form role="search" method="get" action="<?php echo esc_url(get_the_permalink($nokri['sb_search_page'])); ?>" class="custom-search-form">
                        <div class="form-group">
                            <input type="text" id="autocomplete-dynamic" autocomplete="off" class="form-control" name="job-title" value="<?php echo esc_attr($title); ?>" placeholder="<?php echo esc_attr__('Enter keyword or title', 'nokri') ?>">
...
class nokri_feature_candidate_widget extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_feature_candidate_widget',
            // Base ID
            esc_html__('Featured Candidates', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show Feature Candidates', 'nokri'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab">
                <a class="collapsed" role="button" data-bs-toggle="collapse" href="#feature-candidate" aria-expanded="false">
...
class nokri_feature_employer_widget extends WP_Widget
{
    ...
    {
        parent::__construct(
            'nokri_feature_employer_widget',
            // Base ID
            esc_html__('Featured Employer', 'nokri'),
            // Name
            array(
                'description' => esc_html__('Show Feature Employer', 'nokri'),
            ) // Args
        );
    }
    ...
    ?>
        <div class="panel panel-default">
            <div class="panel-heading" role="tab">
                <a class="collapsed" role="button" data-bs-toggle="collapse" href="#feature-employer" aria-expanded="false">
                    <?php echo esc_html($title) ?>
                </a>
            </div>
...
/* ========================= */
/*  Work Remotely search widget */
/* ========================= */

function nokri_remote_job_widget_init()
{
    register_widget('Nokri_Remote_Job_Widget');
}
add_action('widgets_init', 'nokri_remote_job_widget_init');

// register nokri Widget widget

class Nokri_Remote_Job_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'nokri_remote_job_baseid',
            __('Remote Job Widget', 'nokri'),
            array('description' => __('This is a Remote Job Widget', 'nokri'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        echo nokri_job_taxonomies_checkboxes($work_remotely, $instance);
    }
    public function form($instance)
    {
        $title = !empty($instance['title']) ? $instance['title'] : esc_html__('New title', 'nokri');
    ...
    ?>
        ...
        <p>
            ...
            <select class="widefat">
                <option>
                    <?php echo esc_html__('Work Remotely', 'nokri') ?>
                </option>
            </select>
        </p>
        <!--Open/Close  --->
