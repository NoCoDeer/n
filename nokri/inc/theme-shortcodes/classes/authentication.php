    ...
    class authentication {
        ...
        function nokri_sign_up_form($string = "", $terms = array(), $section_user_name = '', $section_user_email = '', $section_user_password = '', $section_term = '', $section_user_btn = '', $section_user_phone = '', $key_code = '', $section_term_link = '', $section_emp_btn = '', $section_cand_btn = '', $section_already_txt = '', $login_txt = '', $default_btn = "", $show_pasword = "", $show_pass_confirm = "") {
            ...
            if ((isset($nokri['job_post_for_admin'])) && $nokri['job_post_for_admin'] !== '1') {
                ...
                $regsiter_buttons = '<div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="btn-group" id="status" btn-chcek="buttons">
                       <label class="btn btn-default btn-md abc ' . $active_emp . '">
                     <input type="radio" value="1" class="custom-icon" name="sb_reg_type" ' . $employer . '>' . $section_emp_btn . '</label>
                       </label>
                       <label class="btn btn-default btn-md ' . $active_cand . '">
                        <input type="radio" value="0" class="custom-icon" name="sb_reg_type" ' . $candidate . '>' . $section_cand_btn . '</label>
                       </label>
                    </div>
                 </div>';
            }
            ...
            if ($var_num) {
                ...
                $phone_field = '  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="form-group">
                     <input placeholder="' . esc_attr__('Phone Number', 'nokri') . '" class="form-control" type="text" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter Valid number with country code.', 'nokri') . '" name="sb_reg_contact" id="sb_reg_contact">
                    </div>
                 </div>';
                                  ...
                                  <div class="modal-content">
                                     ...
                                     <form id="sb-ph-verification">
                                        <div class="modal-body">
                                           ...
                                           <label id="verification_label"> </label>
                                             ...
                                             <input class="form-control" type="text" name="sb_ph_number_code" id="sb_ph_number_code">
                                               <small class="float-end">' . __('Did not get code?', 'nokri') . ' <a href="javascript:void(0);" class="small_text" id="resend_now">' . __('Resend now', 'nokri') . '</a></small>
                                           </div>
                                        </div>
                                        <div class="modal-footer">                                     
                                              ...
                                              <input type="hidden"  value="' . esc_attr(get_the_permalink($signin_page)) . '"  id="sign_in_page">
                                        </div>
                                 </form>
                                  </div>
                               </div>
            ...
            if ($show_pasword == "yes") {
                $show_pasword_div = ' <div class="col-lg-12 col-md-12 col-sm-12 ">
            ...
            if ($show_pass_confirm == "yes") {
                ...
                $show_pass_confirm_div = '<div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="form-group ">
                       <input placeholder="' . esc_attr__('Confirm password', 'nokri') . '" class="form-control" type="password" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please confirm your password.', 'nokri') . '" name="sb_reg_conf_password" id="sb_reg_conf_password" >
            ...
            if ($nokri['google_recaptcha_key'] !== "" && $contact_recaptcha) {
                $recaptcha = ' <div class="col-lg-12 col-md-12 col-sm-3 "><div class="g-recaptcha form-group" name="contact-recaptcha" data-sitekey="' . esc_attr($nokri['google_recaptcha_key']) . '">
                                        </div></div> ';
            }
            $subscribe_check = "";
            ...
            return '<form id="sb-signup-form" method="post" >
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group">
                        <input placeholder="' . esc_attr($section_user_name) . '" class="form-control" type="text" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter your name.', 'nokri') . '" name="sb_reg_name" >
                    </div>
                 </div>
                
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group">
                      <input placeholder="' . esc_attr($section_user_email) . '" class="form-control" type="email" data-parsley-type="email" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter your valid email.', 'nokri') . '" data-parsley-trigger="change" name="sb_reg_email" id="sb_reg_email">
                    </div>
                 </div>
                ' . $phone_field . '                                       
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group  custom-parsely password-container">
                    <i class="fa fa-eye-slash" id="toggle-password" style="cursor: pointer;"></i>
                       <input placeholder="' . esc_attr($section_user_password) . '" class="form-control show-password" type="password" data-parsley-required="true" data name="sb_reg_password" id="sb_reg_password" 
                            ' . $validators . '>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="buttons-area">
                                            ' . $subscribe_check . '
                       <div class="form-group">
                          <input type="checkbox" name="icheck_box" class="input-icheck-others" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please accept terms and conditions.', 'nokri') . '" >
                          <p> ' . esc_html__('I Agree', 'nokri') . ' <a href="' . $section_term_link . '" target="_blank">' . $section_term . '</a></p>
                       </div>                                         
                       <button class="btn n-btn-flat btn-mid float-end ' . esc_attr($rtl_class) . '" type="submit" id="sb_register_submit">' . $section_user_btn . '</button>
                       <button class="btn n-btn-flat btn-mid float-end ' . esc_attr($rtl_class) . ' no-display disabled" type="button" id="sb_register_msg">' . esc_html__('Processing...', 'nokri') . '</button>
                       <button class="btn n-btn-flat btn-mid float-end ' . esc_attr($rtl_class) . ' no-display disabled" type="button" id="sb_register_redirect">' . esc_html__('Redirecting...', 'nokri') . '</button>
                    </div>
                 </div>     
                <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <input type="hidden" id="verify_msg" value="' . esc_attr__('Verification code has been sent.', 'nokri') . '" />
                   <input type="hidden" id="nonce" value="' . esc_attr($key_code) . '" />
        ...
        function nokri_sign_in_form($key_code = '', $already_acount = '', $sign_up = '', $submit_button = '', $forgot_password = '', $user_email_plc = "", $user_password_plc = "", $remember_me = "", $show_pasword = "") {
            ...
            if ($show_pasword == "yes") {
                ...
                $show_pasword_div = '<div class="form-group float-end">
                           <input type="checkbox" name="show_password" id="show_password" class="input-icheck-others" >
                          <p> ' . esc_html__('Show password', 'nokri') . '</p>
                      </div>';
            }
            ...
            $ext_div = '<div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="remember_area abc">
                       ' . $remember_div . '
                       ' . $show_pasword_div . '                               
                    </div>
                 </div>';
            ...
            if ($var_num) {
                ...
                $verification_modal .= '<div class="custom-modal">
                     ...
                     <input placeholder="' . esc_attr__('Your Email', 'nokri') . '" class="form-control" type="email" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter Valid email.', 'nokri') . '" name="user_email" id="user_email" readonly>
                    </div>                            
                                       <div class="form-group">
                                         <label>' . __('Enter your registered phone number e.g +923311212122', 'nokri') . '</label>
                     <input placeholder="' . esc_attr__('Phone Number', 'nokri') . '" class="form-control" type="text" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter Valid number with country code.', 'nokri') . '" name="user_phone_number" id="user_phone_number">
                    </div>
                                           <div class="form-group sb_ver_ph_code_div no-display">
                                           <div>
                                           <label id="verification_label"> </label>
                                             ...
                                             <label>' . __('Enter code', 'nokri') . '</label>
                                             <input class="form-control" type="text" name="sb_ph_number_code" id="sb_ph_number_code"   data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter Valid code', 'nokri') . '">
                                               <small class="float-end">' . __('Did not get code?', 'nokri') . ' <a href="javascript:void(0);" class="small_text" id="resend_now">' . __('Resend now', 'nokri') . '</a></small>
                                           </div>
                                           
                                        </div>
                                        <div class="modal-footer">                                     
                                              <button class="n-btn-flat no-display" type="button" id="sb_verification_processing">' . __('Processing ...', 'nokri') . '</button>
                                              <button class=" n-btn-flat no-display" type="submit" id="verify_acc">' . __('Verify now', 'nokri') . '</button>                                              
                                              <input type="hidden"  value="' . esc_attr(get_the_permalink($signin_page)) . '"  id="sign_in_page">
                                        </div>
                                 </form>
                                  </div>
            ...
            return '<form id="sb-login-form-data"  >
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group">
                       <input placeholder="' . esc_attr($user_email_plc) . '" class="form-control" type="email" data-parsley-type="email" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter your valid email.', 'nokri') . '" data-parsley-trigger="change" name="sb_reg_email" id="sb_reg_email" autocomplete="off">
                    </div>
                 </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group password-container">
                       <input placeholder="' . esc_attr($user_password_plc) . '" class="form-control show-password" type="password" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter your password.', 'nokri') . '" name="sb_reg_password" id="sb_reg_password" class="reg_show_pass" autocomplete="off">
                       <i class="fa fa-eye-slash" id="toggle-password" style="cursor: pointer;"></i>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group clearfix">
                       <a href="#" class="float-start' . esc_attr($rtl_class) . '" data-bs-target="#myModal" data-bs-toggle="modal">' . ($forgot_password) . '</a>
                       <button class="btn n-btn-flat btn-mid float-end' . esc_attr($rtl_class) . '" type="submit" id="sb_login_submit">' . ($submit_button) . '</button>
                                   <button class="btn n-btn-flat btn-mid float-end ' . esc_attr($rtl_class) . ' no-display" type="button" id="sb_login_msg" disabled>' . esc_html__('Processing...', 'nokri') . '</button>
                                   <button class="btn n-btn-flat btn-mid float-end' . esc_attr($rtl_class) . ' no-display" type="button" id="sb_login_redirect" disabled>' . esc_html__('Redirecting...', 'nokri') . '</button>
                    </div>
                 </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="signup-area">
           ...
           <input type="hidden" class="get_action" value="login" />
                    <input type="hidden" id="acc_not_verified" value="' . esc_attr__("Your account is not verified yet.", "nokri") . '" />
        </form>' . $verification_modal . '';
        }
            ...
            <form id="sb-forgot-form">
                 <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input placeholder="' . esc_attr__('Your Email Where We Send You New Password', 'nokri') . '" class="form-control" type="email" data-parsley-type="email" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please enter valid email.', 'nokri') . '" data-parsley-trigger="change" name="sb_forgot_email" id="sb_forgot_email">
                    </div>
                 </div>
                 <div class="modal-footer">
                       <button class="n-btn-flat btn-mid btn-block" type="submit" id="sb_forgot_submit">' . esc_html__('Reset My Account', 'nokri') . '</button>
...
if (!function_exists('nokri_login_user')) {
    ...
    function nokri_login_user() {
        ...
        $remember = false;
        $remember_me = isset($params['remember_me']) ? sanitize_text_field($params['remember_me']) : false;
        if ($remember_me == "on") {
            $remember = true;
        }
            ...
            if (nokri_recaptcha_verify($nokri['google_recaptcha_secret_key'], $params['g-recaptcha-response'], $_SERVER['REMOTE_ADDR'], '')) {
                ...
                if (!is_wp_error($user)) {
                    if (count((array) $user->roles) == 0) {
                        echo esc_html__('Your account is not verified yet.', 'nokri');
                        die();
                    } else {
    ...
    function nokri_register_user() {
        ...
        if ($var_num) {
            ...
            if (!preg_match("/\+[0-9]+$/", $phone)) {
                echo "6|" . esc_html__('Please add valid phone number +CountrycodePhonenumber', 'nokri');
                die();
            }
        }
        if (email_exists($params['sb_reg_email']) == false) {
            ...
            $subscribe_now = isset($params['subscribe_now']) ? sanitize_text_field($params['subscribe_now']) : "off";
            if ($subscribe_now == "on") {
            ...
            if ($var_num && $phone !== "") {
                ...
                if ($sms_sent) {
                    ...
                    echo "6|" . esc_html__("Mobile number verification is on and Server not responding.", 'nokri');
                    update_user_meta($uid, '_sb_is_ph_verified', '0');
                    die();
                }
            }
...
if (!function_exists('nokri_verification_system_fun')) {
    ...
    function nokri_verification_system_fun() {
        $code = isset($_POST['code_entered']) ? sanitize_text_field($_POST['code_entered']) : "";
        $user_id = "";
...
if (!function_exists('nokri_login_verification_system_fun')) {
    ...
    function nokri_login_verification_system_fun() {
        ...
        $code = isset($params['sb_ph_number_code']) ? sanitize_text_field($params['sb_ph_number_code']) : "";
        $email = isset($params['user_email']) ? sanitize_text_field($params['user_email']) : "";
        $phone_number = isset($params['user_phone_number']) ? sanitize_text_field($params['user_phone_number']) : "";
...
if (!function_exists('nokri_check_social_user')) {
    ...
    function nokri_check_social_user($keycode = '', $email = '', $name = '', $headline = '', $profile_url = '') {
        ...
        $network = (isset($_POST['sb_network'])) ? sanitize_text_field($_POST['sb_network']) : '';
        ...
        if ($network == 'facebook') {
            ...
            if (isset($token_verify['response']['code']) && $token_verify['response']['code'] == '200') {
                ...
                if (isset($_POST['email']) && isset($token_verify['body'])) {
                    if (isset($info->email) && $info->email == sanitize_text_field($_POST['email'])) {
        ...
        if ($response_response == false) {
            echo esc_html('0|error|Invalid request|Authentication failed');
            die();
        }
        ...
        $is_demo = nokri_demo_mode();
        if ($is_demo) {
            echo '3|' . esc_html__("Edit in demo user not allowed", 'nokri');
            die();
        }
        if ($keycode !== "" || $_POST['key_code'] !== "") {
            ...
            if (email_exists($user_name) == true) {
                ...
                if ($user) {
                    ...
                    if ($keycode == "") {
                        echo '1|' . esc_html( $_SESSION['sb_nonce']) . '|1|' . esc_html__("You're logged in successfully.", 'nokri');
                    } else {
                        return 1;
                    }
                }
                ...
                if ($keycode == "") {
                    echo '1|' . esc_html($_SESSION['sb_nonce']) . '|1|' . esc_html__("You're registered and logged in successfully.", 'nokri');
                } else {
                    $user = get_user_by('email', $user_name);
                    $user_id = $user->ID;
                    if ($user) {
            ...
            echo esc_html__('0|error|Invalid request|Diret Access not allowed'.'nokri');
        }
        die();
    }
    ...
    if ($keycode !== "" || $_POST['key_code'] !== "") {
        ...
        if (email_exists($user_name) == true) {
            ...
            if ($user) {
                ...
                //do_action( 'wp_login', $user->user_login );
                if ($keycode == "") {
                    echo '1|' . esc_html($_SESSION['sb_nonce']) . '|1|' . esc_html__("You're logged in successfull.", 'nokri');
                } else {
                    return 1;
                }
            }
...
if (!function_exists('nokri_reset_password')) {
        ...
        function nokri_reset_password() {
            ...
            if (count($token_arr) < 2) {
                echo '0|' . esc_html__("Invalid security token format.", 'nokri');
                die();
            }
            ...
            // Check if token from DB is not empty and strictly matches the provided token key
            if (empty($token_db) || $token_db !== $key) {
                echo '0|' . esc_html__("Invalid security token.", 'nokri');
            } else {
                $new_password = sanitize_text_field($params['sb_new_password']);
...
function nokri_emp_profiles() {
    global $nokri;
    // nonce verfication for edit porfile...
    $params = array();
    parse_str($_POST['sb_data'], $params);
    if (empty($params['emp_profile_nonce']) || !wp_verify_nonce($params['emp_profile_nonce'], 'emp_profile_nonce_action')) {
        // If nonce is missing or invalid, exit the function and display a message
        echo '3';
        die();
    }
    ...
    if (is_array($params) && !empty($params)) {
        $emp_name = isset($params['emp_name']) ? sanitize_text_field($params['emp_name']) : '';
        $emp_headline = isset($params['emp_headline']) ? sanitize_text_field($params['emp_headline']) : '';
        $emp_web = isset($params['emp_web']) ? sanitize_text_field($params['emp_web']) : '';
        $emp_est = isset($params['emp_est']) ? sanitize_text_field($params['emp_est']) : '';
        $emp_search = isset($params['is_in_search']) ? sanitize_text_field($params['is_in_search']) : '';
        $emp_intro = isset($params['emp_intro']) ? sanitize_text_field($params['emp_intro']) : '';
        
        $emp_phone = isset($params['sb_reg_contact']) ? sanitize_text_field($params['sb_reg_contact']) : '';
        $emp_entity = isset($params['emp_entity']) ? sanitize_text_field($params['emp_entity']) : '';
        $emp_nos = isset($params['emp_nos']) ? sanitize_text_field($params['emp_nos']) : '';
        $emp_dp = isset($params['emp_dp']) ? sanitize_text_field($params['emp_dp']) : '';
        $emp_profile = isset($params['emp_profile']) ? sanitize_text_field($params['emp_profile']) : "";
        $emp_lat = isset($params['ad_map_lat']) ? sanitize_text_field($params['ad_map_lat']) : '';
        $emp_long = isset($params['ad_map_long']) ? sanitize_text_field($params['ad_map_long']) : '';
        $emp_adress = isset($params['emp_adress']) ? sanitize_text_field($params['emp_adress']) : '';
        $emp_fb = isset($params['emp_fb']) ? sanitize_text_field($params['emp_fb']) : '';
        $emp_twitter = isset($params['emp_twitter']) ? sanitize_text_field($params['emp_twitter']) : '';
        $emp_linked = isset($params['emp_linked']) ? sanitize_text_field($params['emp_linked']) : '';
        $emp_google = isset($params['emp_google']) ? sanitize_text_field($params['emp_google']) : '';
        $emp_map_location = isset($params['sb_user_address']) ? sanitize_text_field($params['sb_user_address']) : '';
        $emp_postal_address = isset($params['sb_user_postal']) ? sanitize_text_field($params['sb_user_postal']) : '';
        $emp_cat = isset($params['emp_cat']) ? sanitize_text_field($params['emp_cat']) : '';
        $emp_video = isset($params['emp_video']) ? sanitize_text_field($params['emp_video']) : '';
    }
    ...
    /* countries */
    $cand_location = array();
    if (isset($params['cand_country']) && $params['cand_country'] !== "") {
        $cand_location[] = isset($params['cand_country']) ? sanitize_text_field($params['cand_country']) : '';
    }
    if (isset($params['cand_country_states']) && $params['cand_country_states'] !== "") {
        $cand_location[] = isset($params['cand_country_states']) ? sanitize_text_field($params['cand_country_states']) : '';
    }
    if (isset($params['cand_country_cities']) && $params['cand_country_cities'] !== "") {
        $cand_location[] = isset($params['cand_country_cities']) ? sanitize_text_field($params['cand_country_cities']) : '';
    }
    if (isset($params['cand_country_cities']) && $params['cand_country_towns'] !== "") {
        $cand_location[] = isset($params['cand_country_towns']) ? sanitize_text_field($params['cand_country_towns']) : '';
    }
...
if (!function_exists('nokri_user_cover_pic')) {
    ...
    function nokri_user_cover_pic() {
        global $nokri;
        if (!isset($_POST['upload_cover_image_nonce']) || !wp_verify_nonce($_POST['upload_cover_image_nonce'], 'upload_cover_image_nonce_action')) {
            echo '0|' . esc_html__('Nonce verification failed!', 'nokri');
            die();
        }
        $user_id = get_current_user_id();
        /* demo check */
        ...
        // Get image gallery value, or set it to an empty string if it's not set
        $image_gallery = isset($_POST["my_cover_upload"]) ? $_POST["my_cover_upload"] : '';
         // Initialize the attachment_ids variable as an empty array
         $attachment_ids = array();
        /* img upload */
        $condition_img = 7;
        $img_count = count((array) explode(',', $image_gallery));
        ...
        if (!empty($attachment_ids)) {
            update_user_meta($uid, '_sb_user_cover', sanitize_text_field($attachment_idss));
        }
...
if (!function_exists('nokri_add_to_cart')) {
    ...
    function nokri_add_to_cart() {
        ...
        if ($user_id == "0" || $user_id == 0 || $user_id == "") {
            echo '0|' . esc_html__("You must need to logged in", 'nokri') . '|' . get_the_permalink($signin_page);
            die();
        }
        ...
        if ($user_type == '0' && $is_pkg_for == '1') {
            echo '5|' . esc_html__("This is employer package", 'nokri');
            die();
        }
        if ($is_avail == 1 && $_POST['is_free'] == 1) {
            echo '4|' . esc_html__("You have already availed free package", 'nokri') . '|' . get_the_permalink($nokri['package_page']);
            die();
        }
        if ($_POST['is_free'] == 1 && $is_pkg_free == 1) {
            ...
            echo '3|' . esc_html__("Success", 'nokri') . '|' . get_the_permalink($nokri['sb_post_ad_page']);
            die();
        }
        $qty = $_POST['qty'];
        global $woocommerce;
        ...
        if ($woocommerce
            ...
            echo '1|' . esc_html__("Added to cart.", 'nokri') . '|' . $woocommerce
                    ->cart
                    ->get_cart_url();
        } else {
            echo '1|' . esc_html__("Already in your cart.", 'nokri') . '|' . $woocommerce
                    ->cart
                    ->get_cart_url();
        }
        die();
...
if (!function_exists('nokri_add_to_cart_cand')) {
    ...
    function nokri_add_to_cart_cand() {
        ...
        $is_demo = nokri_demo_mode();
        if ($is_demo) {
            echo '6|' . esc_html__("Editing not allowed in demo mode", 'nokri') . '|' . get_the_permalink();
            die();
        }
        ...
        if ($user_type == 1 && $is_pkg_for == 0) {
            echo '7|' . esc_html__("This is candidate package", 'nokri');
            die();
        }
...
// Ajax handler for Login User
add_action('wp_ajax_sb_req_sub', 'nokri_job_req');
// Login User
if (!function_exists('nokri_job_req')) {

    function nokri_job_req() {
        global $nokri;
        $user_id = get_current_user_id();
        $user_role = get_user_meta($user_id, '_sb_reg_type', true);
            ...
            if($user_role == '1')
            {
                ...
                $user_name = isset($_POST['jb_user']) ? sanitize_text_field($_POST['jb_user']) : '';
                $user_email = isset($_POST['jb_email']) ? sanitize_email($_POST['jb_email']) : '';
                $job_det_file = isset($_FILES['jb_file']) ? $_FILES['jb_file'] : '';
                $job_desc = isset($_POST['jb_det']) ? sanitize_text_field($_POST['jb_det']) : '';

                // Process file upload
                $file_url = '';
                if ($job_det_file) {
                    $upload_overrides = array('test_form' => false);
                    $file = wp_handle_upload($job_det_file, $upload_overrides);
                ...
                // Create new job request post
                $post_data = array(
                    'post_title' => $user_name, // You can change this as per your requirements
                ...
                // Save additional meta data (file URL)
                if (!empty($file_url)) {
                    update_post_meta($post_id, '_det_file', $file_url);
                }
                if (!empty($user_email)) {
                    update_post_meta($post_id, '_jb_email', $user_email);
                }

                // Prepare response data
                //  $response = array(
                //     'success' => $post_id ? true : false,
                //     'message' => $post_id ? 'Job request submitted successfully.' : 'Failed to submit job request. Please try again later.',
                // );
...
if (!function_exists('nokri_ad_posting')) {
    ...
    function nokri_ad_posting() {
        ...
        if(empty($job_params['job_post_page_nonce']) || !wp_verify_nonce($job_params['job_post_page_nonce'],'job_post_page_nonce_action')) {
            echo '4';
            die();
        }
        // Getting values
        ...
        /* Categories Level */
        $categories = array();
        if (isset($job_params['job_cat']) && $job_params['job_cat'] !== "") {
            $categories[] = $job_params['job_cat'];
        }
        if (isset($job_params['job_cat_second']) && $job_params['job_cat_second'] !== "") {
            $categories[] = $job_params['job_cat_second'];
        }
        if (isset($job_params['job_cat_third']) && $job_params['job_cat_third'] !== "") {
            $categories[] = $job_params['job_cat_third'];
        }
        if (isset($job_params['job_cat_forth']) && $job_params['job_cat_forth'] !== "") {
            $categories[] = $job_params['job_cat_forth'];
        }
        wp_set_post_terms($pid, $categories, 'job_category');
        /* countries */
        $countries = array();
        if (isset($job_params['ad_country']) && $job_params['ad_country'] !== "") {
            $countries[] = $job_params['ad_country'];
        }
        if (isset($job_params['ad_country_states']) && $job_params['ad_country_states'] !== "") {
            $countries[] = $job_params['ad_country_states'];
        }
        if (isset($job_params['ad_country_cities']) && $job_params['ad_country_cities'] !== "") {
            $countries[] = $job_params['ad_country_cities'];
        }
        if (isset($job_params['ad_country_towns']) && $job_params['ad_country_towns'] !== "") {
        ...
        // $tags = isset($job_params['job_tags']) && is_string($job_params['job_tags']) ? explode(',', $job_params['job_tags']) : [];
...
if (!function_exists('nokri_job_action')) {
    ...
    function nokri_job_action() {
        $user_id = get_current_user_id();
        $cv_action = sanitize_text_field($_POST['cv_action']);
        $job_id = sanitize_text_field($_POST['job_id']);
        $cand_id = sanitize_text_field($_POST['cand_id']);
        if ($cv_action !== "") {
...
if (!function_exists('nokri_create_email_templates')) {
    ...
    function nokri_create_email_templates() {
        ...
        if(empty($email_params['email_temp_nonce']) || !wp_verify_nonce($email_params['email_temp_nonce'], 'email_temp_nonce_action')) {
            echo '3';
            die();
        }
...
if (!function_exists('nokri_del_email_temp')) {
    ...
    function nokri_del_email_temp() {
        ...
        if(empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'del_email_temp_nonce_action')) {
            echo '3';
            die();
        }
        $user_id = get_current_user_id();
...
if (!function_exists('nokri_template_select')) {
    ...
    function nokri_template_select() {
        ...
        $meta_key = sanitize_text_field($_POST['temp_val']);
        if ($meta_key !== "") {
        ...
        $html = '<input type="hidden" value="' . esc_attr($template_for) . '"  name="cand_status_val" />
                                <div class="form-group no-email-subject">
                                    <input  type="text" class="form-control" name="email_sub" value="' . esc_attr($template_subject) . '" placeholder="' . esc_attr__('Subject', 'nokri') . '" required>
                                </div>
                            <div class="form-group no-email-body">
                        <label class="">' . esc_html__("Email template.", 'nokri') . '</label>
                        <textarea name="email_body" rows="6" class="form-control rich_textarea" placeholder="' . esc_attr__('Cover Letter', 'nokri') . '" required>' . esc_html($template_body) . '</textarea>
                    </div>';
...
if (!function_exists('nokri_sending_email')) {
 ...
 if ($cand_status == '5' || $cand_status == 5) {
    // Call the function
    nokri_send_candidate_status_job($job_id, $candidate_id);
    if ($candidate_id !== "") {
        update_post_meta($job_id, '_job_applied_status_' . $candidate_id, $cand_status);
    }
    // If the code reaches here, it means the function was executed successfully
    if ($is_send_mail == 'true') {
        $subject = $send_email_params['email_sub'];
        $body = $send_email_params['email_body'];
        $from = isset($nokri['sb_job_status_message_from']) ? $nokri['sb_job_status_message_from'] : '';
        nokri_employer_status_email($job_id, $candidate_id, $subject, $body, $from);
    }
    echo 1;
    die();
...
if (!function_exists('nokri_inactive_job')) {
    ...
    function nokri_inactive_job() {
        ...
        if(empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'],'post_activation_nonce_action')) {
            echo '3';
            die();
        }
        $job_id = sanitize_text_field($_POST['job_id']);
...
if (!function_exists('nokri_del_my_job')) {
    ...
    function nokri_del_my_job() {
        ...
        $emp_job_id = sanitize_text_field($_POST['emp_job_id']);
        if(empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'],'del_my_job_nonce_action')) {
            echo '3';
            die();
        }
...
if (!function_exists('nokri_un_following_followers')) {
    ...
    function nokri_un_following_followers() {
        if(empty($_POST['nonce'])  || !wp_verify_nonce($_POST['nonce'], 'unfollow_cands_nonce_action')) {
            echo '3';
            die();
        }
        $user_id = get_current_user_id();
...
if (!function_exists('nokri_change_password')) {
    ...
    function nokri_change_password() {
        ...
        if(empty($password_data['update_password_nonce']) || !wp_verify_nonce($password_data['update_password_nonce'], 'update_password_nonce_action')) {
            echo '5';
            die();
        }
...
if (!function_exists('nokri_delete_my_account')) {
    ...
    function nokri_delete_my_account() {
        /* demo check */
        if(empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'del_my_acc_nonce_action')) {
            echo '5';
            die();
        }
        $is_demo = nokri_demo_mode();
...
if (!function_exists('nokri_contact_me')) {
    ...
    function nokri_contact_me() {
        ...
        if(empty($contact_me_params['contact_me_nonce']) || !wp_verify_nonce($contact_me_params['contact_me_nonce'], 'contact_me_nonce_action')) {
            echo '3';
            die();
        }
        ...
        if (isset($contact_me_params['g-recaptcha-response'])) {
            ...
            if (nokri_recaptcha_verify($nokri['google_recaptcha_secret_key'], $contact_me_params['g-recaptcha-response'], $_SERVER['REMOTE_ADDR'], '')) {
                ...
                echo '0|' . esc_html__("Please verify captcha.", 'nokri');
                die();
            }
        } else {
...
if (!function_exists('job_attachments')) {
    ...
    function job_attachments() {
        ...
        if ($_GET['is_update'] !== "") {
            $job_id = sanitize_text_field($_GET['is_update']);
        } else {
        ...
        $actual_size = $size_arr[0];
        // Allow certain file formats
        $custom_upload_name = $_FILES['custom_upload']['name'];
        $imageFileType = strtolower(end(explode('.', $custom_upload_name)));
        $formats = array();
        $is_valid = false;
...
if (!function_exists('get_uploaded_job_attachments')) {
    ...
    function get_uploaded_job_attachments() {
        if ($_POST['is_update'] !== "") {
            $job_id = sanitize_text_field($_POST['is_update']);
        } else {
...
if (!function_exists('nokri_emp_saving_resume')) {
    ...
    function nokri_emp_saving_resume() {
        ...
        if (empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'saving_resume_nonce_action')) {
            echo "8";
            die();
        }
        $is_demo = nokri_demo_mode();
...
if (!function_exists('nokri_deleting_saved_resumes')) {
    ...
    function nokri_deleting_saved_resumes() {
        ...
        if(empty($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'del_saved_resume_nonce_action')) {
            echo '4';
            die();
        }
        $user_id = get_current_user_id();
...
if (!function_exists('nokri_email_this_job_popup')) {
    ...
    function nokri_email_this_job_popup() {
        ...
        $job_id = sanitize_text_field($_POST['email_job_id']);
                  ...
                  <div class="modal fade resume-action-modal" id="myModal-job">
                    <div class="modal-dialog modal-lg">
                      ...
                      <div class="col-md-12 col-sm-3 ">
                       <div class="form-group">
                          <label>' . esc_html__('Enter Receiver Email', 'nokri') . '</label>
                          <input placeholder="' . esc_attr__('Enter valid email address', 'nokri') . '" class="form-control" type="email" data-parsley-type="email" data-parsley-required="true"  data-parsley-error-message="' . esc_attr__('Please enter valid email', 'nokri') . '" data-parsley-trigger="change" name="sb_reciever_email">
                       </div>
                 </div>
                        
                        <div class="modal-footer">
                        '. wp_nonce_field('unfollow_comp_nonce_action', 'unfollow_comp_nonce') .'
...
if (!function_exists('nokri_download_admin_resumes_call')) {
    ...
    function nokri_download_admin_resumes_call() {
        ...
        $job_id = isset($_POST['download_job_id']) ? sanitize_text_field($_POST['download_job_id']) : "";
    ...
    function nokri_post_user_ratting() {
        ...
        if (isset($nokri['google_recaptcha_key']) && isset($nokri['google_recaptcha_secret_key']) && $nokri['google_recaptcha_key'] !== '' && $nokri['google_recaptcha_secret_key'] !== '') {
            if (nokri_recaptcha_verify($nokri['google_recaptcha_secret_key'], $params['g-recaptcha-response'], $_SERVER['REMOTE_ADDR'], $params['emp_review_captcha'])) {
                $rating_service_stars = sanitize_text_field($params['rating_service']);
                $rating_process_stars = sanitize_text_field($params['rating_process']);
                $rating_selection_stars = sanitize_text_field($params['rating_selection']);
                $review_title = sanitize_text_field($params['review_title']);
                $review_message = sanitize_text_field($params['review_message']);
                $employer_id = sanitize_text_field($params['employer_id']);
    ...
    function nokri_post_cand_ratting() {
        ...
        if (isset($nokri['google_recaptcha_key']) && isset($nokri['google_recaptcha_secret_key']) && $nokri['google_recaptcha_key'] !== '' && $nokri['google_recaptcha_secret_key'] !== '') {
            if (nokri_recaptcha_verify($nokri['google_recaptcha_secret_key'], $params['g-recaptcha-response'], $_SERVER['REMOTE_ADDR'], $params['cand_review_captcha'])) {
                ...
                $review_title = sanitize_text_field($params['review_title']);
                $review_message = sanitize_text_field($params['review_message']);
                $employer_id = sanitize_text_field($params['emp_id']);
    ...
    function fun_load_more_jobs() {
        ...
        if (isset($arr['order_job'])) {
            if (isset($arr['order_job']) && $_GET['order_job'] !== "") {
                $order = sanitize_text_field($arr['order_job']);
            }
        }
...
if (!function_exists('nokri_upload_resume_single_video_fun')) {
    ...
    function nokri_upload_resume_single_video_fun() {
        ...
        if ($vid_convert_to_mb > $vid_actual_size) {
            echo '0|' . esc_html__("Max allowd video size in MB is", 'nokri') . " " . $vid_actual_size;
            die();
        }
        if (!in_array($format_name, $allowed_format)) {

            $format_message = esc_html__("Format not supported , allowed format are", 'nokri') . " " . "mp4,m4v,avi,3gp,mov";
        ...
        if (!is_wp_error($attachment_id)) {
            ...
            echo '0|' . esc_html__("Something went wrong please try later", 'nokri');
            die();
        }
    }
...
if (!function_exists('nokri_delete_upload_video')) {
    ...
    function nokri_delete_upload_video() {
        ...
        $attachment_id_ = sanitize_text_field($_POST['video']);
        $user_id = get_current_user_id();
        if ($attachment_id_) {
            ...
            echo '0|' . esc_html__("File not Deleted", 'nokri');
            die();
        }
    }
...
function nokri_upload_cropped_image() {
    ...
    if (isset($_POST['cropped_img']) && $_POST['cropped_img'] !== "") {
        ...
        $cropped_img = sanitize_text_field($_POST['cropped_img']);
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">                      
                        <div class="modal-header">                   
                            ...
                            <button type="button" id ="custom_close" name ="close_account_member_btn" class="close" data-dismiss="modal">&times;</button>
                        </div>
                                ...
                                <div class="form-group account-members">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-3  col-sm-3">                                    
                                            ...
                                            <input placeholder="' . esc_attr__('Member Title', 'nokri') . '" class="form-control account-members" type="text" name="u_title"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Member Title', 'nokri') . '">      
                                        </div>
                                        <div class="col-lg-6 col-md-3  col-sm-3"> 
                                            <label>' . esc_html__('Designation:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Designation', 'nokri') . '" class="form-control account-members" type="text" name="u_designation"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Designation', 'nokri') . '">
                                        </div>
                                         <div class="col-lg-6 col-md-3  col-sm-3"> <label>' . esc_html__('Upload Image:*', 'nokri') . '</label>
                                            <input class ="input-b2" type="file" id="u_img" name="u_img" accept="jpg,jpeg"></div>
                                        <div class="col-lg-6 col-md-3  col-sm-3">  <label>' . esc_html__('Experience:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Experience', 'nokri') . '" class="form-control account-members" type="text" name="u_experience"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Experience', 'nokri') . '"></div>

                                        <div class="col-lg-6 col-md-3  col-sm-3"><label>' . esc_html__('Facebook URL:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Facebook URL', 'nokri') . '" class="form-control account-members" type="text" name="u_fburl"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Facebook URL', 'nokri') . '"> </div>
                                        <div class="col-lg-6 col-md-3  col-sm-3"> <label>' . esc_html__('Twitter URL:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Twitter URL', 'nokri') . '" class="form-control account-members" type="text" name="u_twiturl"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Twitter URL', 'nokri') . '"></div>
                                                <div class="col-lg-6 col-md-3  col-sm-3"> <label>' . esc_html__('LinkedIn URL:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('LinkedIn URL', 'nokri') . '" class="form-control account-members" type="text" name="u_linkedin"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('LinkedIn URL', 'nokri') . '"></div>
                                          </div>
                                       </div>
                                    <div class="modal-footer">
                                    '. wp_nonce_field("emp_profile_nonce_action", "add_memder_nonce") . '
...
if (!function_exists('nokri_add_team_members_fun')) {
    ...
    function nokri_add_team_members_fun() {
        ...
        $params = array();
        parse_str($_POST['form_data'], $params);
        if (empty($params['add_memder_nonce']) || !wp_verify_nonce($params['add_memder_nonce'], 'emp_profile_nonce_action')) {
            $message = esc_html__('Nonce Verfication Faild!', 'nokri');
            echo '3|' . $message;
            die();
        }
            ...
            foreach ($files['name'] as $key => $value) {
                if ($files['name'][$key]) {
                    ...
                    if ($file['size'] === $nokri['team_member_pic_size']) {
                        $mess = esc_html__("Please select a different image of size", 'nokri') . " " . $display_size;
                        echo '0|' . esc_html($mess);
                        die();
                    }
                    foreach ($_FILES as $file => $array) {
        ...
        if (is_array($old_data) && count($old_data) > 0) {
            ...
            $message = esc_html__('New member added succesfully', 'nokri');
            // echo '1|' . esc_html($message);
        } else {
            $member_array[$random_string] = $member_data;
...
function nokri_edit_team_form() {
    ...
    $memeber_id = isset($_POST['memeber_id']) ? sanitize_text_field($_POST['memeber_id']) : "";
    if ($memeber_id == "") {

        echo esc_html(" No Data Found", 'nokri');
    }
    $user_id = get_current_user_id();
    ...
    $image_basename = basename($image_source); // Get full file name
                $image_extension = pathinfo($image_basename, PATHINFO_EXTENSION); // Get extension
                $short_name = substr($image_basename, 0, 6) . '...' . $image_extension; // Shorten name
    ?>
<!-- Modal -->
                    ...
                    <div class="form-group account-members">
                        <div class="row">
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                ...
                                <input placeholder="<?php esc_attr__('Member Title:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_title); ?>" name="u_title"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('Member Title', 'nokri') . '">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Designation:', 'nokri'); ?></label>
                                <input placeholder="<?php esc_attr__('Designation:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_designation); ?>" name="u_designation"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('Designation', 'nokri') . '">
                            </div>
                            <div class="col-lg-6 col-md-3 col-sm-3">
                                <label><?php echo esc_html__('Profile Image', 'nokri'); ?></label>
                                <div class="d-flex align-items-center">
                                    <!-- Image Name -->
                                    <span class="me-2"><?php echo esc_html($team_member_name); ?></span>

                                    <!-- Image Preview & Remove Button -->
                                    <div class="d-flex align-items-center">
                                        <?php if (!empty($image_source)) : ?>
                                            <a class="image-preview profile-preview me-2" data-fancybox="gallery" href="<?php echo esc_url($image_source); ?>">
                                                <img src="<?php echo esc_url($image_source); ?>" alt="image-preview" style="width:50px; height:50px; border-radius:50%;">
                                            </a>
                                            <span class="me-2"><?php echo esc_html($short_name); ?></span>
                                            <!-- <button type="button" class="btn btn-outline-danger btn-sm remove-image"> 
                                                <i class="fa fa-trash"></i> <?php //echo esc_html__('Remove', 'nokri'); ?>
                                            </button> -->
                                        <?php endif; ?>
                                    </div>

                                    <!-- File Upload -->
                                    <input type="hidden" value="<?php echo esc_attr($team_member_image); ?>" name="image_id">
                                    <input class="d-none" type="file" id="u_img" name="u_img" accept="image/jpeg,image/jpg">
                                    <label for="u_img" class="btn btn-outline-secondary btn-sm ms-2">
                                        <i class="fa fa-folder-open"></i> <?php echo esc_html__('Browse', 'nokri'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Experience:', 'nokri'); ?></label>
                                <input placeholder="<?php esc_attr__('Experience:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_experience); ?>" name="u_experience"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('Experience', 'nokri') . '">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Facebook URL:', 'nokri'); ?></label>
                                <input placeholder="<?php esc_attr__('Facebook:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_fburl); ?>" name="u_fburl"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('Facebook URL', 'nokri') . '">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Twitter URL:', 'nokri'); ?></label>
                                <input placeholder="<?php esc_attr__('Twitter URL:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_twiturl); ?>" name="u_twiturl"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('Twitter URL', 'nokri') . '">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('LinkedIn URL:', 'nokri'); ?></label>
                                <input placeholder="<?php esc_attr__('LinkedIn URL:', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($team_member_linkedin); ?>" name="u_linkedin"
                                    data-parsley-required="true"
                                    data-parsley-error-message="' . esc_attr__('LinkedIn URL', 'nokri') . '">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                    <?php wp_nonce_field('edit_member_nonce_action', 'edit_memder_nonce') ?>
                        <button type="button" id="update_member_btn" name="submit_btn"
                            data-member_id="<?php echo esc_attr($memeber_id); ?>"
                            class="btn n-btn-flat btn-mid"><?php echo esc_html__('Update', 'nokri'); ?></button>
                        <button type="button" id="custom_close" class="btn btn-default"
                            data-dismiss="modal"><?php echo esc_html__('Close', 'nokri'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
if (!function_exists('nokri_update_team_members_func')) {
    ...
    function nokri_update_team_members_func() {
        ...
        $params = array();
        parse_str($_POST['form_data'], $params);
        if(empty($params['edit_memder_nonce']) || !wp_verify_nonce($params['edit_memder_nonce'], 'edit_member_nonce_action')) {
            echo '3';
            die();
        }
        $is_demo = nokri_demo_mode();
        ...
        $memeber_id = isset($_POST['member_id']) ? sanitize_text_field($_POST['member_id']) : "";
        ...
        $image_id = isset($params['image_id']) ? sanitize_text_field($params['image_id']) : "";
        $member_data = array();
...
if (!function_exists('nokri_delete_team_members_func')) {
    ...
    function nokri_delete_team_members_func() {
        ...
        $is_demo = nokri_demo_mode();
        if ($is_demo) {
            echo '0|' . esc_html__("You can not delete because demo mode is enabled.", "nokri");
            die();
        }
        if(empty($_POST['nonce_id']) || !wp_verify_nonce($_POST['nonce_id'], 'delete_member_nonce_action')) {
            echo '3|' . esc_html__("Nonce Verification Faild!",'nokri');
            die();
        }
        $user_id = get_current_user_id();
        if (isset($_POST['member_id']) && $_POST['member_id'] !== "") {
            ...
            if (array_key_exists($member_id, $team_memebrs_data)) {
                ...
                echo '1|' . esc_html__("Member Deleted Successfully", "nokri");
            } else {
                echo '0|' . esc_html__("Member Already Deleted", "nokri");
            }
        } else {
            echo '0|' . esc_html__("Something went wrong", "nokri");
        }
        die();
    }
...
if (!function_exists('nokri_zoom_auth_user_func')) {
    ...
    function nokri_zoom_auth_user_func() {
        ...
        $is_demo = nokri_demo_mode();
        if ($is_demo) {
            echo '0|' . esc_html__("demo mode is enabled.", "nokri");
            die();
        }
        $user_id = get_current_user_id();
        $params = array();
        ...
        if ($zoom_client_id !== '') {
            ...
            ?>
<script>
var zoom_auth_window = window.open(
    'https://zoom.us/oauth/authorize?response_type=code&state=<?php echo '' . ($state) ?>&client_id=<?php echo esc_html($zoom_client_id); ?>&redirect_uri=<?php echo esc_url($redirect_uri); ?>',
    ...
    function nokri_get_token_access_zoom() {
        ...
        if (isset($_GET['code']) && $_GET['code'] !== '') {
            ...
            if (isset($result_token['access_token']) && $result_token['access_token'] !== "") {
                ...
                $message = esc_html__("Token Generated Successfully now you can use Zoom Meeting services", "nokri");
    ...
    function nokri_terms_and_conditions() {
        ...
        if ($termsText) {
            ...
            $terms_html .= '<div class="form-group">
                                <p><input type="checkbox" id="check_social_terms"  name="icheck_box_terms" class="input-icheck-others" data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Please accept terms and conditions.', 'nokri') . '">
                                    ' . esc_html($termsText) . ' <a href="' . esc_url(get_the_permalink($terms_link)) . '" target="_blank">' . esc_html__('Terms and Conditions', 'nokri') . '</a></p>
                            </div>';
            return $terms_html;
        }
    }
...
if (!function_exists('nokri_account_members_from')) {
    ...
    function nokri_account_members_from() {
        ...
        echo '<!-- Modal -->
            <div class="modal fade resume-action-modal in" data-bs-backdrop="static" id="account_member_modal_form" role="dialog">
                <div class="cp-loader"></div>
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">                      
                                ...
                                <div class="form-group account-members">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-3  col-sm-3">                                    
                                            ...
                                            <input placeholder="' . esc_attr__('Member First Name', 'nokri') . '" class="form-control account-members" type="text" id ="member_first_name" name="member_first_name"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Member First Name', 'nokri') . '">      
                                        </div>
                                        <div class="col-lg-6 col-md-3  col-sm-3"> 
                                            <label>' . esc_html__('Last Name:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Member Last Name', 'nokri') . '" class="form-control account-members" type="text" id ="member_last_name" name="member_last_name"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Member Last Name', 'nokri') . '">
                                        </div>
                                        <div class="col-lg-6 col-md-3  col-sm-3">  <label>' . esc_html__('Member Username:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Member Username', 'nokri') . '" class="form-control account-members" type="text" id ="ac_member_username" name="ac_member_username"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Member Username', 'nokri') . '"></div>

                                        <div class="col-lg-6 col-md-3  col-sm-3"><label>' . esc_html__('Member Email:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Member Email', 'nokri') . '" class="form-control account-members" type="text" id ="ac_member_email" name="ac_member_email"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Member Email', 'nokri') . '"> </div>
                                        <div class="col-lg-6 col-md-3  col-sm-3"> <label>' . esc_html__('Password:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Password', 'nokri') . '" class="form-control account-members" type="password" id ="ac_member_password" name="ac_member_password"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Password', 'nokri') . '"></div>
                                                <div class="col-lg-6 col-md-3  col-sm-3"> <label>' . esc_html__('Confirm Password:', 'nokri') . '</label> 
                                            <input placeholder="' . esc_attr__('Confirm Password', 'nokri') . '" class="form-control account-members" type="password" id ="ac_member_confirm_pass" name ="ac_member_confirm_pass"  data-parsley-required="true" data-parsley-error-message="' . esc_attr__('Confirm Password', 'nokri') . '"></div>
                                          </div>
                                    ...
                                    <div class="modal-footer">
                                    '. wp_nonce_field('add_account_member_nonce_action', 'add_account_memder_nonce') .'
...
function nokri_account_member_permissions() {
    ...
    if(empty($params['add_account_memder_nonce']) || !wp_verify_nonce($params['add_account_memder_nonce'], 'add_account_member_nonce_action')) {
        echo '3|' . esc_html__('Nonce Verification Faild!', 'nokri');
        die();
    }
    
    $DataArray = array();
    $DataArray['firstName'] = isset($params['member_first_name']) ? sanitize_text_field($params['member_first_name']) : '';
    $DataArray['lastName'] = isset($params['member_last_name']) ? sanitize_text_field($params['member_last_name']) : '';
    $DataArray['userName'] = isset($params['ac_member_username']) ? sanitize_text_field($params['ac_member_username']) : '';
    $DataArray['userEmail'] = isset($params['ac_member_email']) ? sanitize_text_field($params['ac_member_email']) : '';
    $DataArray['userPassword'] = isset($params['ac_member_password']) ? sanitize_text_field($params['ac_member_password']) : '';
    $DataArray['userConfPass'] = isset($params['ac_member_confirm_pass']) ? sanitize_text_field($params['ac_member_confirm_pass']) : '';
    ...
    if (isset($params['employer_id'])) {
        $emp_user_id = sanitize_text_field($params['employer_id']);
    } else {
    ...
    if (is_array($memberPermissions) && !empty($memberPermissions)) {
        if ($emp_user_id > 0) {
            ...
            if ($userEmail !== '' && $error == 0 && filter_var($userEmail, FILTER_VALIDATE_EMAIL)) {
                ...
                $error = 1;
                echo '0|' . esc_html__("Enter a valid email Address", "nokri");
            }
            if ($userPassword !== '' && $error == 0) {
                $userPassword = esc_html($userPassword);
            } else {
                $error = 1;
                echo '0|' . esc_html__("Password Required", "nokri");
            }
            if ($userPassword !== $userConfPass && $error == 0) {
                $error = 1;
                echo '0|' . esc_html__("Confirm password does not match", "nokri");
            }
            if ($error == 1) {
                die;
            }
            ...
            if (is_wp_error($createUser)) {
                ...
                $user_id = $createUser;
                $secureToken = wp_generate_password(32, false, false);
                $DataArray['token'] = $secureToken;
                ...
                update_user_meta($user_id, 'member_secure_token', $secureToken); // Store secure token
                
                // Email for new user
                if (function_exists('sb_team_member_welcome_email')) {
                    sb_team_member_welcome_email($user_id, $userPass);
                }
                echo '1|' . esc_html__("Account member has been added successfully", "nokri");
                die;
            }
        } else {
            echo '0|' . esc_html__("You are not allowed to add an account Member", "nokri");
            die;
        }
    } else {
        echo '0|' . esc_html__("Select atleast one permission", "nokri");
        die;
    }
}
...
function nokri_edit_acc_members() {
    ...
    if ($member_id == "") {
        echo esc_html__('No Data forund' . 'nokri');
        die();
    }
    $user_id = get_current_user_id();
    $membersData = get_user_meta($user_id, 'account_members', true);
    $token = get_user_meta($member_id, 'member_secure_token', true);
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" id="close_account_member_form" name="close_account_member_btn" class="close"
            ...
            <div class="modal-body account-members">
                <form id="acc_memberModal_form" class="job-form">
                    <div class="form-group account-members">
                        <div class="row">
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                ...
                                <input placeholder="<?php echo esc_attr__('Member First Name', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($firstName); ?>" id="member_first_name"
                                    name="member_first_name" data-parsley-required="true"
                                    data-parsley-error-message="<?php echo esc_attr__('Member First Name', 'nokri'); ?>">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Last Name:', 'nokri'); ?></label>
                                <input placeholder="<?php echo esc_attr__('Member Last Name', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($lastName); ?>" id="member_last_name"
                                    name="member_last_name" data-parsley-required="true"
                                    data-parsley-error-message="<?php echo esc_attr__('Member First Name', 'nokri'); ?>">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Member Email:', 'nokri'); ?></label>
                                <input placeholder="<?php echo esc_attr__('Member Email', 'nokri'); ?>"
                                    class="form-control account-members" type="text"
                                    value="<?php echo esc_attr($userEmail); ?>" id="ac_member_email"
                                    name="ac_member_email" data-parsley-required="true"
                                    data-parsley-error-message="<?php echo esc_attr__('Member Email', 'nokri'); ?>">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Password', 'nokri'); ?></label>
                                <input placeholder="<?php echo esc_attr__('Password', 'nokri'); ?>"
                                    class="form-control account-members" type="password"
                                    value="<?php echo esc_attr($userPassword); ?>" id="ac_member_password"
                                    name="ac_member_password" data-parsley-required="true"
                                    data-parsley-error-message="<?php echo esc_attr__('Password', 'nokri'); ?>">
                            </div>
                            <div class="col-lg-6 col-md-3  col-sm-3">
                                <label><?php echo esc_html__('Confirm Password', 'nokri'); ?></label>
                                <input placeholder="<?php echo esc_attr__('Confirm Password', 'nokri'); ?>"
                                    class="form-control account-members" type="password"
                                    value="<?php echo esc_attr($userConfPass); ?>" id="ac_member_confirm_pass"
                                    name="ac_member_confirm_pass" data-parsley-required="true"
                                    data-parsley-error-message="<?php echo esc_attr__('Confirm Password', 'nokri'); ?>">
                            </div>
                        </div>
                        <li class="form-group nokri-members-acc-allow">
                            <div class="nokri_members_allowed_permisons">
                                ...
                                <ul>
                                    <li><input id="nokri_sb_emp_dashbo" name="nokri_sb_mem_permss[emp_dashboard]"
                                            class="icheckbox_square n_memb_check_permissions" type="checkbox"
                                            <?php echo esc_attr($emp_dashboard); ?>><label
                                            for="nokri_sb_emp_dashbo"><?php echo esc_html__('Dashboard', 'nokri'); ?></label>
                                    </li>
                                    <li><input id="nokri_sb_job_post" name="nokri_sb_mem_permss[ad_post]"
                                            class="icheckbox_square n_memb_check_permissions" type="checkbox"
                                            <?php echo esc_attr($ad_post); ?>><label
                                            for="sb_new_job_post"><?php echo esc_html__('Post New Job', 'nokri'); ?></label>
                                    </li>
                                    <li><input id="nokri_sb_edit_profile" name="nokri_sb_mem_permss[edit_profile]"
                                            class="icheckbox_square n_memb_check_permissions" type="checkbox"
                                            <?php echo esc_attr($edit_profile); ?>><label
                                            for="sb_edit_profile"><?php echo esc_html__('Edit Profile', 'nokri'); ?></label>
                                    </li>
                                    <li><input id="nokri_sb_manage_jobs" name="nokri_sb_mem_permss[manag_jobs]"
                                            class="icheckbox_square n_memb_check_permissions" type="checkbox"
                                            <?php echo esc_attr($manag_jobs); ?>><label
                                            for="sb_manage_jobs"><?php echo esc_html__('Manage Jobs', 'nokri'); ?></label>
                                    </li>
                                    <li><input id=" nokri_sb_save_cands" name="nokri_sb_mem_permss[save_cands]"
                                            class="icheckbox_square n_memb_check_permissions" type="checkbox"
                                            <?php echo esc_attr($save_cands); ?>><label
                                            for="sb_save_candidates"><?php echo esc_html__('Save Candidates', 'nokri'); ?></label>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <div class="modal-footer">
                    <?php wp_nonce_field('edit_account_member_nonce_action', 'edit_account_memder_nonce') ?>
                        <input type="hidden" name="member_id" value="<?php echo esc_attr($member_id); ?>">
                        <input type="hidden" name="token_pass" value="<?php echo esc_attr($token); ?>">
                        <button type="submit" id="update_account_member_btn" name="update_account_member_btn"
                            data-memeber-update-id="<?php echo esc_attr($member_id); ?>"
                            class="btn n-btn-flat btn-mid"><?php echo esc_html__('Update Member', 'nokri'); ?></button>
                        <button type="button" id="close_account_member_form" name="close_account_member_btn"
...
if (!function_exists('nokri_delete_account_member')) {
    ...
    function nokri_delete_account_member() {
        ...
        if(empty($_POST['nonce_id']) || !wp_verify_nonce($_POST['nonce_id'], 'delete_account_member_nonce_action')) {
            echo '3|' . esc_html__('Nonce Verification Faild!', 'nokri');
            die();
        }
        $user_id = get_current_user_id();
...
if (!function_exists('nokri_update_account_member')) {
    ...
    function nokri_update_account_member() {
        ...
        $params = array();
        parse_str($_POST['form_data'], $params);
        $secureToken = isset($params['token_pass']) ? sanitize_text_field($params['token_pass']) : '';
        if (!$secureToken) {
            echo esc_html__("Invalid member token", "nokri");
            die();
        }

        $userQuery = new WP_User_Query([
            'meta_key'   => 'member_secure_token',
            'meta_value' => $secureToken,
            'number'     => 1,
            'fields'     => 'ID',
        ]);
        $userResults = $userQuery->get_results();
        if (empty($userResults)) {
            echo '0|' . esc_html__("Invalid member token", "nokri");
            die();
        }
        $member_ID = $userResults[0];
        $user_id = get_current_user_id();
        $current_user = wp_get_current_user();
        $owner_email = $current_user->user_email;
        
        nokri_add_secure_token_to_members($user_id);
        // Fetch existing account members
        $team_members = get_user_meta($user_id, 'account_members', true);
        $team_members = !empty($team_members) && is_array($team_members) ? $team_members : [];
        if (!isset($team_members[$member_ID])) {
            echo '0|' . esc_html__("Member not found", "nokri");
            die();
        }

        // Ensure the secure token exists
        if (empty($team_members[$member_ID]['token'])) {
            $team_members[$member_ID]['token'] = wp_generate_password(32, false, false);
            $sec_Token = $team_members[$member_ID]['token'];
            update_user_meta($member_ID, 'member_secure_token', $team_members[$member_ID]['token']);
        } else {
           $secToken = get_user_meta($member_ID, 'member_secure_token', true);
        }
        
        if(empty($params['edit_account_memder_nonce']) || !wp_verify_nonce($params['edit_account_memder_nonce'], 'edit_account_member_nonce_action')) {
            echo '3|' . esc_html__('Nonce Verification Faild!', 'nokri');
            die();
        }
        $DataArray = array();
        ...
        $DataArray['userEmail'] = isset($params['ac_member_email']) ? sanitize_text_field($params['ac_member_email']) : '';
        $DataArray['memberPermissions'] = isset($params['nokri_sb_mem_permss']) ? ($params['nokri_sb_mem_permss']) : '';
        $DataArray['token'] = $secToken;
        $DataArray['id'] = isset($params['member_id']) ? sanitize_text_field($params['member_id']) : '';
        ...
        if (strtolower($userEmail) === strtolower($owner_email)) {
            echo '0|' . esc_html__("Please use another email.", "nokri");
            exit;
        }
        if (is_array($memberPermissions) && !empty($memberPermissions)) {
            $error = 0;
            ...
            if (is_array($team_memebrs_array) && count($team_memebrs_array) > 0) {
                ...
                echo '1|' . esc_html__("Member Updated Successfully", "nokri");
            } else {
                echo '0|' . esc_html__("Something went wrong", "nokri");
            }
            die();
...
function nokri_add_secure_token_to_members($user_id) {
    $membersData = get_user_meta($user_id, 'account_members', true);
    if (empty($membersData) || !is_array($membersData)) {
        return false;
    }
    $updated = false;
    foreach ($membersData as $member_id => $memberInfo) {
        if (!isset($memberInfo['token']) || empty($memberInfo['token'])) {
            $membersData[$member_id]['token'] = wp_generate_password(32, false, false);
            $updated = true;
        }
        update_user_meta($member_id, 'member_secure_token', $membersData[$member_id]['token']);
    }
    if ($updated) {
        update_user_meta($user_id, 'account_members', $membersData);
    }
    return true;
}
...
if (!function_exists('nokri_firebase_num_verify')) {
    ...
    function nokri_firebase_num_verify() {
        ...
        $user_id = get_current_user_id();
        $phonNo = isset($_POST['phoneNum']) ? sanitize_text_field($_POST['phoneNum']) : "";
        if ($phonNo !== '') {
...
// Ajax handler for Login User
add_action('wp_ajax_invite_candidate_for_jobs', 'nokri_invite_candidate_for_jobs_callback');
if (!function_exists('nokri_invite_candidate_for_jobs_callback')) {

    function nokri_invite_candidate_for_jobs_callback() {
        global $nokri;
        $user_id = get_current_user_id();
        ...
        $cand_id = isset($_POST['cand_id']) ? sanitize_text_field($_POST['cand_id']) : '';
        $params = array();
        parse_str($_POST['cand_data'], $params);
        $post_ids = isset($params['invite_job_ids']) ? sanitize_text_field($params['invite_job_ids']) : array();

        if (!empty($post_ids)) {
            $existing_post_ids = get_user_meta($user_id, 'invite_candidate_' . $cand_id, true);
            $existing_post_ids = is_array($existing_post_ids) ? $existing_post_ids : array();
        
            $post_ids = is_array($post_ids) ? $post_ids : array($post_ids);
        
            $updated_post_ids = array_unique(array_merge($existing_post_ids, $post_ids)); 
            update_user_meta($user_id, 'invite_candidate_' . $cand_id, $updated_post_ids);
        }

        /* Email Sent to Candidate to Invite Jobs */
        if (isset($nokri['sb_send_email_on_invite_cand']) && $nokri['sb_send_email_on_invite_cand'] == true) {
            nokri_invite_cand_on_job($post_ids, $cand_id, $user_id);
        }

        echo '1|' . esc_html__("Success.", "nokri");
        die();
    }
}