...
//    }
    ...
    $side_bar_html = '';
    $col_sizes = 'col-lg-6 col-md-6 col-sm-6 col-xs-12 offset-md-3 offset-lg-3';
    $col_sizes2 = 'col-lg-12 col-md-12 col-sm-12 col-xs-12';
    if ($side_bar) {
        $col_sizes = 'col-lg-10 col-md-10 col-sm-12 col-xs-12 offset-md-1 offset-lg-1';
         ...
         <div class="container">
            <div class="row">
               <div class="' . esc_attr($col_sizes) . '">
                  <div class="row">
                     <div class="n-job-pages register-page nopadding">
