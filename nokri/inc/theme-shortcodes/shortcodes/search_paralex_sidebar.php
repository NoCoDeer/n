...
if (!function_exists('search_tabs_sidebar_short_base_func')) {
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xxl-4 col-lg-4 col-md-8 col-sm-12 m-md-auto m-0 offset-lg-1 offset-sm-2 offset-md-0">
      <form class="form-join"  method="get" action="' . get_the_permalink($nokri['sb_search_page']) . '">
		' . nokri_form_lang_field_callback(false) . '
		  ...
		  <button type="submit" class="btn n-btn-flat btn-block mt-sm-2 mt-2">' . esc_html__('Search', 'nokri') . '<i class="fa fa-search"></i></button>
        </form>
      </div>
    </div>
  </div>
