...
/* Background Image */
$bg_img = '';
if( isset($basic_bg_img) && $basic_bg_img != " " )
{
$img  		        = 	wp_get_attachment_image_src($basic_bg_img,'');
$bgImageURL  		= 	isset($img[0]) ?  $img[0]   :  "";
  	...
  	<div class="container">
    	<div class="row">
                <div class="n-job-pages contact-page">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 nopadding">
