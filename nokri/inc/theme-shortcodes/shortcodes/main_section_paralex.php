   ...
   return   '<section class="n-hero-section" '.str_replace('\\',"",$bg_img).'>
    <div class="container">
      <div class="row  justify-content-center">
      		<div class=" col-lg-10 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
            	<div class="n-hero-box">
                    ...
                    <div class="n-hero-form-cat">
                        ...
                        <div class="n-saech-form">
							<form  method="get" action="'.get_the_permalink($nokri['sb_search_page']).'"><div class="row">
								'.nokri_form_lang_field_callback(false).'
								<div class="row">
                            	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p-md-0">
                                	<div class="row">
                                    	<div class="form-group">
										 <input type="text" class="form-control sch-key px-4 mb-3  mb-xxl-0 mb-md-0 mb-sm-3" name="job-title" placeholder="'.esc_html__('Search Keyword','nokri').'">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p-md-0 ">
                                	<div class="row">
                                        <select class="js-example-basic-single sel-cat-op" data-allow-clear="true" data-placeholder="'.esc_html__('Select Category','nokri').'" style="width: 100%" name="cat-id">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p-md-0">
                                	<div class="row">
                                        <select class="js-example-basic-single sel-cat-loc" data-allow-clear="true" data-placeholder="'.esc_html__('Select Location','nokri').'" style="width: 100%" name="job-location">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                	<div class="row">
									<button type="submit" class="btn n-btn-flat search-btn sub-btn">'.esc_html__('Search','nokri').'<i class="fa fa-search"></i></button>
                                    </div>
                                </div>
								</div>
                            </form>
