...
function signin_short_base_func($atts, $content = '') {
    ...
    /* Section heading */
    $page_heading = (isset($page_heading) && $page_heading != "") ? '<div class="col-lg-12 col-md-12 col-sm-12 "><div class="post-job-heading"><h3>' . $page_heading . '</h3></div></div>' : "";
    /* Social heading */
...
//    }
    ...
    $side_bar_html = '';
    $col_sizes = 'col-lg-6 col-md-6 col-sm-12 offset-md-3 offset-lg-3';
    $col_sizes2 = 'col-lg-12 col-md-12 col-sm-12';
    if ($side_bar == 'yes') {
        $col_sizes = 'col-lg-10 col-md-10 col-sm-12 offset-md-1 offset-lg-1';
        $col_sizes2 = 'col-lg-7 col-md-7 col-sm-12';
        $side_bar_html = '<div class="col-lg-5 col-md-5 col-sm-12 nopadding">
