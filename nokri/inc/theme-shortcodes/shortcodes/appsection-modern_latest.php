...
function app_section_modern_new() {
    vc_map(array(
        "name" => esc_html__("App section Modern Latest", 'nokri'),
        "base" => "app_section_modern_new_base",
        ...
        "params" => array(
            array(
                ...
                'description' => nokri_VCImage('app_section_modern_latest.png') . esc_html__('Ouput of the shortcode will be look like this.', 'nokri'),
            ),
            array(
...
//            ),
            array(
                ...
                "description" => esc_html__('555 × 634', 'nokri'),
            ),
            array(
...
add_action('vc_before_init', 'app_section_modern_new');

function app_section_modern_new_base_func($atts, $content = '') {
    ...
    if (isset($appsection_img)) {
        ...
        $img_thumb = $img[0];
        $appsection_img_html = '<div class="col-md-6 col-sm-6 ">
    ...
    if ($appsection_img != "") {
        ...
        $appsection_img = '<div class="left-img"><img src="' . $section_imgURL . '" alt="' . esc_attr__("Image", "nokri") . '"></div>';
    }
    /* Section Color */
    ...
    return'    <section class="our-free-app">
            <div class="container">
                <div class="row">
...
if (function_exists('nokri_add_code')) {
    nokri_add_code('app_section_modern_new_base', 'app_section_modern_new_base_func');
}