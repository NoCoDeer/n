        ...
        vc_map(array(
            ...
            "params" => array(
                ...
                array(
                    ...
                    'default' => esc_html__('Upload Resume', 'nokri'),
                ),
            ),
        ));
    }
...
if (!function_exists('hero_section1_short_base_func')) {
    ...
    function hero_section1_short_base_func($atts, $content = '') {
        ...
        if (isset($resume_btn_txt)) {
            $cand_btn_txt = '<div class="col-lg-6 col-md-6 col-sm-6"><div class="n-profile-btn"><input type="button"  class="btn n-btn-flat" value="' . esc_attr($resume_btn_txt) . '" name="upload_cand_resume" id="upload_cand_resume cd"></div></div>';
        }
        /* cand Image */
        $cand_image1 = '';
        if (isset($cand_image)) {
