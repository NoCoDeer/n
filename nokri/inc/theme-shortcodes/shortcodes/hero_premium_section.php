        ...
        if ((array) count($rows) > 0) {
            ...
            foreach ($rows as $row) {
                ...
                if (count((array) $term)) {
                    ...
                    $tabs_html .= '<li class="' . esc_attr($active) . '">
    <a class=" " href="#tab' . $row['job_class'] . '" data-bs-toggle="tab">
        <span>' . $term->name . '</span>
    </a>
</li>';
                }
                ...
                if ($job_class_query->have_posts()) {
                    while ($job_class_query->have_posts()) {
                        ...
                        if ($job_apply_with == 'exter') {
                            ...
                            $apply_button = '<a href="' . $href . '" class="btn n-btn-rounded  ' . $simple_app . '" data-bs-toggle="modal" data-target="' . $modal_target . '"  data-job-id=' . esc_attr($job_id) . '>' . esc_html($apply_now_text) . ' </a>';
                        }
                        /* Getting Profile Photo */
                        $rel_image_link[0] = get_template_directory_uri() . '/images/candidate-dp.jpg';
                        if (get_user_meta($post_author_id, '_sb_user_pic', true) != "") {
        ...
        if ($slider_switch) {
            $tabs_col = 12;
            $slider_final_html = '<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        ...
        if ($tabs_slider_switch) {
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-8 col-md-'. esc_attr($tabs_col) . ' col-sm-12 col-xs-12">
                    <div class="row">
