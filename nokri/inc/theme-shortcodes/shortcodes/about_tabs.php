	...
	if(isset($atts['faq_qstns']) && $atts['faq_qstns'] != '')
	{
	   ...
	   {	
			...
			$faq_html .='<div class="panel panel-default">
										...
										<a class="collapse-controle" data-bs-toggle="collapse" data-parent="#accordion" href="#collapse'.esc_attr($tabs_no).'" aria-expanded="true" aria-controls="collapse'.esc_attr($tabs_no).'">
										   '.$qstn_title.'
