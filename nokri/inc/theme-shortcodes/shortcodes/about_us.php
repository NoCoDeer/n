...
function about_us_short_base_func($atts, $content = '')
{
	...
	if(isset($atts['faq_qstns']) && $atts['faq_qstns'] != '')
	{
	   ...
	   {	
			...
			$about_html .='<div class="col-md-6  col-sm-6">
...
if(isset($employer_signup_img))
{
	...
	$img_thumb 	= 	$img[0];
	$img_html    =   '<div class="col-md-5 col-sm-12 "><img src="'.esc_url($img_thumb).'" class="img-responsive"  alt="'.esc_attr__( 'image', 'nokri' ).'"></div>';
}
/*Section Color */
