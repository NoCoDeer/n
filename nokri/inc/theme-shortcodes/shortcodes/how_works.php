...
if(isset($atts['steps']) && !empty($atts['steps']) != '')
{
	...
	/*Step Html */		
	$steps_html .= '<div class="col-xxl-3 col-lg-3 col-md-6 col-sm-12 d-flex">
					<div class="h-i-w-content-box d-flex flex-column">
						'.$astep_img.'
						'.$astep_title.'
						'.$astep_desc.'
					  </div></div>';
...
if(isset($section_img2))
{
	...
	$img_thumb2 	 =   '<div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12"><img src="'.$section_imag2[0].'" class="img-responsive" alt="'. esc_attr__( 'image', 'nokri' ).'"></div>';
}
    ...
    <div class="container">
      <div class="row mx-0">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
        	<div class="row">
            	<div class="row n-call-to-box mt40 align-items-center">
