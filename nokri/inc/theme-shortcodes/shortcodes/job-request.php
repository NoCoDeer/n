...
{
    vc_map(array(
        "name" => esc_html__("Job Request", 'nokri'),
        "base" => "job_request",
...
add_action('vc_before_init', 'job_request');

function job_request_func($atts, $content = '')
{
                                ...
                                <div class="row">
                                    ...
                                    <form id="jb_request_submit">
                                        <div class="modal-body">
                                            ...
                                            <label>' . esc_html__('Enter your Name', 'nokri') . '</label>
                                            ...
                                            <div class="form-group">
                                            <label>' . esc_html__('Enter your email', 'nokri') . '</label>
                                            ...
                                            <div class="form-group">
                                            <label>' . esc_html__('Enter Job Detail File', 'nokri') . '</label>
                                            ...
                                            <div class="form-group">
                                            <label>' . esc_html__('Description (Optional)', 'nokri') . '</label>
...
if (function_exists('nokri_add_code')) {
    nokri_add_code('job_request', 'job_request_func');
}

function nokri_vc_job_request()
{
