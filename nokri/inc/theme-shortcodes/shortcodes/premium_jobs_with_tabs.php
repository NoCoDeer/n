            ...
            if ((array) count($rows) > 0) {
                ...
                foreach ($rows as $row) {
                    ...
                    $tabs_html .= '<li class="nav-item"> 
                            <a class="nav-link ' . esc_attr($active) . '" id="tab' . $row['job_class'] . '-tab" data-bs-toggle="tab" href="#tab' . $row['job_class'] . '" role="tab" aria-controls="tab' . $row['job_class'] . '" aria-selected="true">
                                <span>' . $term->name . '</span>
                            </a> 
                          </li>';
                    $args = array(
                    ...
                    $tabs_content .= '<div id="tab' . $row['job_class'] . '" class="tab-pane fade ' . esc_attr($active_in) . '" role="tabpanel" aria-labelledby="tab' . $row['job_class'] . '-tab">
                                <div class="row">';
                    ...
                    if ($job_class_query->have_posts()) {
                        while ($job_class_query->have_posts()) {
                            ...
                            if ($job_bookmark == '') {
                                $save_job = '<a href="javascript:void(0)" class="n-jobs-rating save_job" data-value = "' . $job_id . '"><i class="fa fa-heart"></i></a>';
                            } else {
                          ...
                          $href_whatsapp = esc_url("https://api.whatsapp.com/send?phone=$job_apply_whatsapp");
                            ...
                            if ($job_apply_with == 'exter') {
                                ...
                                $apply_button = '<a href="'.$href.'" class="'.$simple_app.'" data-bs-toggle="modal" data-target="'.$modal_target.'"  data-job-id=' . esc_attr($job_id) . '>' . esc_html($apply_now_text). ' </a>';
                            }
                            $tabs_content .= '<div class="col-lg-6  col-sm-12 col-md-12">
												<div class="n-categories-content">
												  <div class="n-keywords-jobs-category">
                                                  '.  wp_nonce_field("save_job_nonce_action", "save_job_nonce") .'
												   ' . $save_job . '
					...
					<div class="container">
					  <div class="row">
						...
						<div class="col-lg-12 col-sm-12 col-md-12">
						  ...
						  <div class="n-keywords-nav-tabs">
                          <ul class="nav nav-pills nav-tabs" id="jobClassTab" role="tablist">' . $tabs_html . '</ul>
							<div class="tab-content" id="jobClassTabContent">' . $tabs_content . '</div>
						  </div>
						</div>
					  </div>
					</div>
