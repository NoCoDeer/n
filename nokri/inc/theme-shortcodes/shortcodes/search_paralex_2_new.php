...
if (!function_exists('search_paralex_2_new_short_base_func')) {
    ...
    function search_paralex_2_new_short_base_func($atts, $content = '') {
                ...
                foreach ($rows_hot_cats as $rows_hot_cat) {
                    if (isset($rows_hot_cat['hot_cat'])) {
                        ...
                        if (count((array) $get_hot_cat) == 0)
                            continue;
                        $term_link = get_term_link($get_hot_cat->term_id);
                        $final_url = esc_url(nokri_page_lang_url_callback($term_link));
                        $hot_cats_html .= '<a href="' . $final_url . '">' . $get_hot_cat->name . '</a>';
                    }
                }
            }
        }
        ...
        /* keyowrd Title */
        $keyword_title = (isset($keyword_title) && $keyword_title != "") ? '<label class="form-label"><i class="ti-search"></i>' . " " . $keyword_title . '</label>' : "";
        /* country Title */
        ...
        return '<section class="n-hero-section-two rebuild" ' . str_replace('\\', "", $bg_img) . '>
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1">
                  <div class="n-hero-two-box">
                     ...
                     <div class="n-hero-two-form-cat">
                        <div class="n-saech-two-form">
                            	<form  method="get" action="' . get_the_permalink($nokri['sb_search_page']) . '" style="width:100%;">
