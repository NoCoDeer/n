...
function nokri_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name' => esc_html__('Social Login by miniOrange', 'nokri'),
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/miniorange-login-openid.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/post-views-counter.zip'),
            'is_callable' => ''
        ),
        array(
     ...
     */
    $tgm_enable_notification = true;
    if (class_exists('Redux')) {
        $tgm_enable_notification = Redux::get_option('nokri', 'tgm_notification');

        if ((isset($tgm_enable_notification)) ? $tgm_enable_notification : true) {
            $tgm_enable_notification = $tgm_enable_notification;
        }
    }
    $config = array(
        ...
        'has_notices' => $tgm_enable_notification, // Show admin notices or not.
