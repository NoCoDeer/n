...
$sidebar = '<div class="col-xxl-4 col-lg-4 col-md-12 col-sm-12">
...
<section class="blog-detail-page">
  <div class="container">
    <div class="row">
      <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12 nopadding">
        <div class="row">
          ...
          <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="blog-post">
              ...
              if (has_post_thumbnail()) {
                ...
                echo '<div class="post-img"> <img src="' . get_the_post_thumbnail_url(get_the_ID(), 'full') . '" alt="' . esc_attr__('image', 'nokri') . '" class="img-responsive w-100"> <a href="javascript:void(0)" class="author-icon">' . get_avatar($post->post_author, $size = '45', $default = '', $alt = '', array('class' => array('img-responsive', 'rounded-circle'))) . '</a> </div>';
              }
              ?>
              <div class="blog-single post-desc entry-content">
                <div class="post-info">
                  ...
                  <?php } ?>
                  <a href="javascript:void(0)"><?php echo get_comments_number($pid) . " " . esc_html__("comment", "nokri"); ?></a>
                </div>
