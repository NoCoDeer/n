...
<li class="col-md-4 masonery_item">
    <div class="dwt_listing_shop-grid foo">
        ...
        <div class="dwt_listing_shop-grid-description">
            ...
            // Display product category below title
            echo '<div class="category-wrapper">';
            echo wc_get_product_category_list(', ', '<span class="posted-in">' . _n('Category:', 'Categories:', count($product->get_category_ids()), 'nokri') . ' ', '.</span>');
            echo '</div>';

            // Display product availability below category
            echo '<div class="availability-wrapper">';
