...
?>
<section class="n-single-job nk-detail-pg">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="n-single-title show_icon">
                    ...
                    <ul>
                        ...
                        <li> <i
                                class="fa fa-hand-o-right"></i><?php echo esc_html(nokri_job_post_single_taxonomies('job_type', $job_type)); ?>
                        </li><?php } ?>
                        <li> <i class="fa fa-clock-o"></i><?php echo esc_html(nokri_time_ago()); ?></li>
                ...
                <div class="n-single-meta">
                    <ul class="n-single-meta-detail">
                        ...
                        <li>
                            ...
                            <strong><?php echo esc_html($job_vacancy) . " " . esc_html($opening_text); ?></strong>
                        </li>
                ...
                <div class="n-skills">
                    <h5><i
                            class="fa fa-tags"></i><?php echo nokri_feilds_label('skills_txt', esc_html__('Job skills', 'nokri')); ?>
                    </h5>
                ...
                <aside class="n-single-sidebar">
                    ...
                    <div class="apply-buttons">
                        ...
                        <a href="<?php echo '' . $edit_url; ?>"
                            class="btn n-btn-flat btn-mid btn-clear"><?php echo esc_html__('Edit Job', 'nokri'); ?></a>
                        <?php } else { ?>
                        <?php
                            if ($post_apply_status == 'active') {
                                ...
                                if ($job_apply_with == 'exter') {
                                    ?>
                        <a href="JavaScript:Void(0)" class="btn n-btn-flat btn-mid btn-clear external_apply"
                            data-job-id="<?php echo esc_attr($job_id); ?>"
                            data-job-exter="<?php echo esc_url($job_apply_url); ?>"><?php echo esc_html($apply_now_text); ?></a>
                        <?php } else if ($job_apply_with == 'mail') { ?>
                        <a href="#" class="btn n-btn-flat btn-mid btn-clear email_apply"
                            data-job-id="<?php echo esc_attr($job_id); ?>"
                            data-job-exter="<?php echo '' . ( $job_apply_mail ); ?>"><?php echo esc_html($apply_now_text) ?></a>

                        <?php } else if ($job_apply_with == 'whatsapp') { ?>
                        <a href="https://api.whatsapp.com/send?phone=<?php echo '' . $job_apply_whatsapp ?>"
                            class="btn n-btn-flat btn-mid btn-clear whatsapp_apply"
                            data-job-id="<?php echo esc_attr($job_id); ?>"
                            data-job-exter="<?php echo '' . ( $job_apply_whatsapp ); ?>"><?php echo esc_html($apply_now_text) ?></a>

                        <?php } else {
                                    ?>
                        <a href="javascript:void(0)" class="btn n-btn-flat btn-mid btn-clear apply_job"
                            data-job-id="<?php echo esc_attr($job_id); ?>"
                            data-author-id="<?php echo esc_attr($post_author_id); ?>" data-bs-toggle="modal"
                            data-bs-target="#myModal" id="applying_job"><?php echo esc_html($apply_now_text); ?></a>
                        <?php
                                }
                                /* Enable/disable linkedin apply */
                                if ((isset($nokri['cand_linkedin_apply'])) && $nokri['cand_linkedin_apply'] == 1 && $apply_status == "") {
                                        ...
                                        $redirect_uri = ($nokri['redirect_uri']);
                                          ...
                                          $state = 'not_logged_in-' . $job_id;
                                            ...
                                            $linkedin_url = esc_url('https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=' . $linkedin_api_key . '&redirect_uri=' . $redirect_uri . '&state=' . esc_attr($state) . '&scope=r_liteprofile r_emailaddress');
                                             if (!is_user_logged_in()) {
                                            echo '<a href="' . esc_url($linkedin_url) . '" class="btn-linkedIn btn-block"><i class="ti-linkedin"></i> <span>' . esc_html__('Apply With LinkedIn', 'nokri') . '</span></a>';
                                       }
                                       else {
                                         ...
                                         if( $apply_now_text != "Applied")
                                         {
                                          ...
                                          echo '<a href="'.$pop_up_url.'"  class="btn-linkedIn btn-block"><i class="ti-linkedin"></i> <span>' . esc_html__('Apply With LinkedIn', 'nokri') . '</span></a>';
                                         }        
                                    ...
                                    //     $linkedin_url = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=' . $linkedin_api_key . '&redirect_uri=' . $redirect_uri . ' &state= ' . $state . '&scope=r_liteprofile%20r_emailaddress';
                                    //    if (!is_user_logged_in()) {
                                    ...
                                    //              $state = 'logged_in-' . $job_id;
                                    //       $pop_up_url   =  get_the_permalink($job_id) .  "/?src=lkn";
                                    //       echo '<a href="'.$pop_up_url.' &state= '.$state.' " class="btn-linkedIn btn-block"><i class="ti-linkedin"></i> <span>' . esc_html__('Apply With LinkedIn', 'nokri') . '</span></a>';
                                    //    }
                                ...
                                ?><a href="javascript:void(0)"
                            class="btn n-btn-flat btn-mid btn-clear"><?php echo esc_html__('Job Expired', 'nokri'); ?></a> <?php
                            }
                        }
                        ?>
                        <?php wp_nonce_field('save_job_nonce_action', 'save_job_nonce') ?>
                        <a class="btn btn-block n-btn-custom-two save_job" href="javascript:void(0)"
                            data-value=<?php echo esc_attr($job_id); ?>><?php echo esc_html__('Save This Job', 'nokri'); ?>
                        </a>
                        <?php if ($is_email_job) { ?>
                        
                        <a class="btn n-btn-custom btn-block email_this_job" href="javascript:void(0)"
                            data-job-id=<?php echo esc_attr($job_id); ?>><?php echo esc_html__('Email This Job', 'nokri'); ?>
                        </a>
                        ...
                        if (current_user_can('manage_options') && $job_apply_with != "exter" && $job_apply_with != "email") {
                            ?>
                        <a class="btn n-btn-custom btn-block download_admin_resumes" href="javascript:void(0)"
                            data-job-id=<?php echo esc_attr($job_id); ?>><?php echo esc_html__('Download resumes', 'nokri'); ?>
                        </a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="n-single-job-company">
                        <a class="btn btn-block n-btn-custom job-report" href="javascript:void(0)"
                            data-user-id=<?php echo esc_attr($user_id); ?>
                            data-job-id=<?php echo esc_attr($job_id); ?>><?php echo esc_html__('Report This Job', 'nokri'); ?>
                        </a>
                    </div>
                    <?php
                        }
                    ...
                    <div class="n-single-job-company">
                        <a class="btn btn-block n-btn-flat" href="javascript:void(0)">
                            <h4><?php echo esc_html__('Job Reported', 'nokri'); ?></h4>
                            <h4><?php echo esc_html($reports_counter); ?></h4>
                        </a>
                    </div>
                    <?php
                        }
                    ...
                    <div class="n-single-job-company">
                        <div class="dingle-job-company-meta">
                            ...
                            <ul class="social-links list-inline">
                                <?php if ($emp_fb) { ?>
                                <li> <a href="<?php echo esc_url($emp_fb); ?>"><img
                                            src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/006-facebook.png'); ?>"
                                            alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                <?php } if ($emp_google) { ?>
                                <li> <a href="<?php echo esc_url($emp_google); ?>"><img
                                            src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/003-google-plus.png'); ?>"
                                            alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                <?php } if ($emp_twitter) { ?>
                                <li> <a href="<?php echo esc_url($emp_twitter); ?>"><img
                                            src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/004-twitter.png'); ?>"
                                            alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                <?php } if ($emp_linkedin) { ?>
                                <li> <a href="<?php echo esc_url($emp_linkedin); ?>"><img
                                            src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/005-linkedin.png'); ?>"
                                            alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                <?php } ?>
                            </ul>
                            <?php } ?>
                            <div class="contact-img">
                                <img src="<?php echo esc_url($image_link[0]); ?>" class="img-responsive img-circle"
                                    alt="<?php echo esc_attr__('company profile image', 'nokri'); ?>">
                            </div>
                            <div class="contact-caption">
                                <h4><?php echo esc_html($company_name); ?></h4>
                                <a href="<?php echo esc_url($web); ?>"
                                    target="_blank"><?php echo esc_html__('Visit Website', 'nokri'); ?></a>
                            </div>
                        </div>
                        <a class="view-profile"
                            href="<?php echo esc_url(get_author_posts_url($post_author_id)); ?>"><?php echo esc_html__('Visit Profile', 'nokri'); ?></a>
                    </div>
                        ...
                        if (!empty($lats_longs) && count((array) $lats_longs) > 0) {
                            ...
                            if ($results->have_posts()) {
                                while ($results->have_posts()) {
                                    ...
                                    $li .= '<li>
                                        <div class = "recently-added-img"><a href = "' . esc_url($image_link[0]) . '"> <img class = "img-fluid" src = "' . esc_url($image_link[0]) . '" alt = ""> </a> </div>
                    ...
                    <div class="panel panel-default nearby_jobs">
                        <div class="panel-heading" role="tab">
                            <a class="collapsed" role="button" data-bs-toggle="collapse" href="#feature-candidate"
                                aria-expanded="false">
                ...
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label><?php echo esc_html__('Enter your linkedin profile url', 'nokri'); ?><span
                                    class="color-red">*</span></label>
                            <input placeholder="<?php echo esc_attr__('Enter your linkedin profile url', 'nokri'); ?>"
                                class="form-control" type="text" name="linkedin_url" data-parsley-required="true"
                                data-parsley-error-message="<?php echo esc_attr__('Enter your linkedin profile url', 'nokri'); ?>">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <?php wp_nonce_field("submit_linkedin_url_nonce_action", "submit_linkedin_url_nonce"); ?>
                        <button type="submit" name="submit"
                            class="btn n-btn-flat btn-mid btn-block submit_linkedin_url">
