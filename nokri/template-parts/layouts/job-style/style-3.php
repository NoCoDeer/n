...
<div class="posted-job-list" id="all-jobs-list-box2-<?php echo esc_attr($job_id); ?>">
    <ul class="list-inline">
        <li class="posted-job-title"> 
            <a href="<?php echo esc_url(get_the_permalink($job_id)); ?>"><?php esc_html(the_title()); ?></a>
            <p><strong><?php echo esc_html__('Posted Date', 'nokri'); ?>: </strong><?php echo esc_html(get_the_date()); ?></p>
        ...
        <li class="posted-job-applicants"><?php echo esc_html($resume_counts); ?></li>
        <li class="posted-job-expiration"><?php echo esc_html(date_i18n(get_option('date_format'), strtotime($job_expiry))); ?></li>
        <li class="posted-job-action"> 
            <ul class="list-inline">
                ...
                ?>
                <li class="tool-tip" title="<?php echo esc_attr__('View Applications', 'nokri'); ?>"> <a href="<?php echo '' . $final_url; ?>" class="label label-success"> <i class="ti-files"></i></a></li>
                <?php
                if ($job_status == 'active') {
                    ...
                    ?>
                    <li class="tool-tip" title="<?php echo esc_attr__('Edit Job', 'nokri'); ?>"> <a href="<?php echo '' . $final_url; ?>" class="label label-info"> <i class="ti-pencil-alt"></i></a></li>
                <?php } ?>
                <li class="tool-tip" title="<?php echo esc_attr__('Delete Job', 'nokri'); ?>"><?php wp_nonce_field('del_my_job_nonce_action', 'del_my_job_nonce'); ?><a data-value="<?php echo esc_attr($job_id); ?>" class="label label-danger del_my_job"> <i class="ti-trash"></i></a></li>
                <?php if ($job_status == 'active' && $take_action == true) { ?>
                    <li class="tool-tip" title="<?php echo esc_attr__('Make inactive', 'nokri'); ?>"><?php wp_nonce_field('post_activation_nonce_action', 'post_activation_nonce'); ?><a  id="inactive"  class="label label-warning inactive_job" data-value="<?php echo esc_attr($job_id); ?>"> <i class="ti-alert"></i></a></li>
                <?php } else if ($take_action == true) { ?>
                    <li class="tool-tip" title="<?php echo esc_attr__('Make active', 'nokri'); ?>"><?php wp_nonce_field('post_activation_nonce_action', 'post_activation_nonce'); ?><a  id="active"  class="label label-success inactive_job" data-value="<?php echo esc_attr($job_id); ?>"> <i class="ti-alert"></i></a></li>
                    <?php
                }
                if ($is_show_bump_up && $job_status == 'active') {
                    $emp_single_job_stats
                    ?>
                    <li class="tool-tip" title="<?php echo esc_attr__('Bump Up', 'nokri'); ?>"><a  id="bump_this_job"  class="label label-success bump_this_job" data-value="<?php echo esc_attr($job_id); ?>"> <i class="ti-arrow-up"></i></a></li>
                    <?php
                }
                if ($emp_single_job_stats && $job_status == 'active') {
                    ...
                    ?>
                    <li class="tool-tip" title="<?php echo esc_attr__('Statistics', 'nokri'); ?>">
                        <a data-bs-toggle="modal" data-class= "track-resume" data-value="<?php echo esc_attr($post_title); ?>" 
