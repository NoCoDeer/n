...
<div class="col-md-4 col-sm-12 col-xs-12 col-md-push-8">
   ...
   <div class="contact-box hidden-xs hidden-sm">
      ...
      <li> <a href="<?php echo get_user_meta( $post_author_id, '_emp_fb',true); ?>"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/006-facebook.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
      <li> <a href="<?php echo get_user_meta( $post_author_id, '_emp_twitter',true); ?>"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/004-twitter.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
      <li> <a href="<?php echo get_user_meta( $post_author_id, '_emp_google',true); ?>"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/003-google-plus.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
      <li> <a href="<?php echo get_user_meta( $post_author_id, '_emp_linked',true); ?>"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/005-linkedin.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
      </ul>
      <?php
