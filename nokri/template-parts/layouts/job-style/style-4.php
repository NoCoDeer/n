...
<section class="light-blue remove-padding">
    <div class="bg-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">

                    <div class="n-detail-jobs-content">                       
                        <div class="n-detail-job-title">
                            ...
                            ?>
                            <a href="javascript:void(0)"><h3><?php the_title(); ?></h3></a>
                            <ul>
                                <li class="n-selector">
                                    <p><i class="fa fa-folder-open"></i><?php echo '' . $project; ?></p>
                                    <?php if (!empty($job_type)) { ?>
                                    </li>
                                    <li>
                                        <p><i class="fa fa-hand-o-right"></i><?php echo esc_html(nokri_job_post_single_taxonomies('job_type', $job_type)); ?></p>
                                    </li>
                                <?php } ?>
                                <li>
                                    <p><i class="fa fa-clock-o"></i><?php echo esc_html(nokri_time_ago()); ?></p>
                                </li>
                        ...
                        <div class="n-detail-social-icons">
                            <?php
                            /* Author Check */
                                    ...
                                    if ($post_apply_status == 'active') {
                                      ...
                                      $state = 'not_logged_in-' . $job_id;
                                            ...
                                            $linkedin_url = esc_url('https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=' . $linkedin_api_key . '&redirect_uri=' . $redirect_uri . '&state=' . esc_attr($state) . '&scope=r_liteprofile r_emailaddress');
                                             ...
                                             echo '<a href="' . esc_url($linkedin_url) . '" class="btn n-btn-flat btn-mid btn-clear"><i class="ti-linkedin"></i> <span>' . esc_html__('Apply With LinkedIn', 'nokri') . '</span></a>';
                                       }
                                       else {
