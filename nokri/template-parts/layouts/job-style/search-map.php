    ...
    <div class="left-part">
        <div class="col-md-12 col-xs-12 col-sm-12 side-listings">
            <div class="n-search-main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <form method="GET" id="job_order_search">
                                <select class="js-example-basic-single form-control change_order" data-allow-clear="true" data-placeholder="<?php echo esc_attr__("Select Option", "nokri"); ?>" style="width: 100%" name="order_job">
                ...
                <?php echo '' . wp_kses($advert_up, get_allowed_html_tags()); ?>
                <?php if ($job_alerts) { ?>
                ...
                <div class="n-search-listing n-featured-jobs featured">
                    <div class="n-featured-job-boxes">
                        ...
                        if (isset($nokri['premium_jobs_class_switch']) && $nokri['premium_jobs_class_switch'] == '1') {
                            ...
                            echo '' . wp_kses($section_title, get_allowed_html_tags());
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <?php } else { ?>
                                <nav aria-label="Page navigation">
                                    <?php echo wp_kses(nokri_job_pagination($results), get_allowed_html_tags()); ?>
                                </nav>                                         
                            <?php } ?>
                        </div>
