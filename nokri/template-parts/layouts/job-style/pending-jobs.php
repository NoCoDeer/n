...
<div class="posted-job-list" id="all-jobs-list-box2-<?php echo esc_attr($job_id); ?>">
    <ul class="list-inline">
        <li class="posted-job-title"> 
            <a href="<?php echo esc_url(get_the_permalink($job_id)); ?>"><?php echo esc_html(get_the_title()); ?></a>
            <p><strong><?php echo esc_html__('Posted Date', 'nokri'); ?>: </strong><?php echo esc_html(get_the_date()); ?></p>
            <div class="job-class"> 
                <?php echo "" . wp_kses($job_badge_text, get_allowed_html_tags()) ?>
            </div>
        </li>
        ...
        <li class="posted-job-action"> 
            <ul class="list-inline">
                ...
                <li class="tool-tip" title="<?php echo esc_attr__('Delete Job', 'nokri'); ?>"><?php wp_nonce_field('del_my_job_nonce_action', 'del_my_job_nonce'); ?><a href="javascript:void(0)" data-value="<?php echo esc_attr($job_id); ?>" class="label label-danger del_my_job"><i class="ti-trash"></i></a></li>
            </ul>
        </li>
