	...
	foreach( $single_job_badges as $job_badge => $val )
		{
			...
			if($color != "" )
			{
				$style_color = 'style=" background-color: '.esc_attr($bg_color).' !important; color: '.esc_attr($color).' !important;"';
			}
            ...
            <div class="single-job-detail-box">
               <div class="row">
				  ...
				  if(get_user_meta($user_id, '_sb_reg_type', true) == 0) 
				  {
                      ...
                      <div class="col-md-5 col-sm-12 col-xs-12">
                         <div class="apply-job">
                            <a href="javascript:void(0)" class="btn btn-theme apply_job" data-job-id="<?php echo esc_attr( $job_id );?>" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo esc_html__( 'Apply Now', 'nokri' ); ?></a>
