...
<section class="nth-footer-4 <?php echo esc_attr($bg_class); ?>" <?php echo nokri_returnEcho($bg_url); ?>>
    <div class="container">
        <div class="row">			
            ...
            <?php echo ''.wp_kses($description, get_allowed_html_tags()); ?>
        </div>
    ...
    <div class="nth-footer-content">
        <div class="container">
		 ...
		 $ft_last_link = isset($nokri['footer_last_link']) ? $nokri['footer_last_link']:  esc_html__("#", "nokri"); ?>
                <div class="col-xxl-8 col-lg-8 col-md-6 col-sm-12">
                ...
                <?php if ($subscribe != '') { ?> 
                <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 input-style">					
