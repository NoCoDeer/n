          ...
          <div class="row n-newsleter-content align-items-center">
              <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="n-newletter">
                  <?php echo ''.wp_kses($subscribe_text, get_allowed_html_tags())." ".wp_kses($description, get_allowed_html_tags()); ?>
                </div>
              </div>
              <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="input-group">
                  <form onSubmit="return checkVals();">
                     ...
                     <input name="sb_email" class="form-control" id="sb_email" placeholder="<?php echo esc_attr__('Enter Email','nokri'); ?> " type="text" autocomplete="off" required>
                     </div>
  ...
  <div class="container">
    <div class="row gta">
      ...
      <div class="n-footer-links">
          <?php echo wp_kses(nokri_footer_input_texts('job_locations_links_text','','h4',''), get_allowed_html_tags()); ?>
          <ul>
            <?php echo wp_kses(nokri_footer_job_taxonomies_links('ad_location','job_locations_links','job-location'),get_allowed_html_tags()); ?>
          </ul>
        </div>
      </div>
      <div class="col-xxl-4 col-lg-4 col-md-4 col-sm-12">
        <div class="n-footer-details"> 
		 <?php echo ''.($footerlogo)." ".wp_kses($logo_below_text, get_allowed_html_tags())." ".nokri_social_footer_sorter(''); ?>
        </div>
      </div>
      <div class="col-xxl-4 col-lg-4 col-md-4 col-sm-12 ">
        <div class="n-footer-links">
          <?php echo wp_kses(nokri_footer_input_texts('footer_hot_links','','h4',''),  get_allowed_html_tags()); ?>
          <ul>
            <?php echo wp_kses(nokri_foot_hot_links_blend(), get_allowed_html_tags()); ?>
          </ul>
        </div>
      </div>
    </div>
