...
class Nokri_Pdf4 extends TCPDF {
...
$pdf = new Nokri_Pdf4(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
...
$html2   =  $about_sec.$cand_profession_html.$cand_education_html.$cand_certificate_html.$skills_bar.$custom_display;
