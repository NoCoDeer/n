...
if (isset($_GET['edit-id']) && $_GET['edit-id'] != "") {
    $template_id = sanitize_text_field($_GET['edit-id']);
...
foreach ($apllied_actions as $val => $key) {
    ...
    $options .= '<option value="' . esc_attr($val) . '" ' . esc_attr($selected) . '>' . esc_html($key) . '</option>';
}
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="<?php echo esc_attr__('Template name', 'nokri'); ?>" required value="<?php echo esc_html($template_name); ?>" name="email_temp_name" class="form-control">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="<?php echo esc_attr__('Email Subject', 'nokri'); ?>" required value="<?php echo esc_html($template_subject); ?>" name="email_temp_subject" class="form-control">
                    </div>
                </div>
                <div class="col-md-12 col-sm-12">
                    <div class="mb-3">
                        ...
                        <select  class="select-resume form-control" name="email_temp_for" required> 
                            <?php echo "" . wp_kses($options, array(
                                            'option' => array(
                                                'value' => true,
                                                'selected' => true,
                                            ),
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="mb-3">
                        <labe><?php echo esc_html__('Description', 'nokri'); ?><span class="required">*</span>
                        </labe>
                        <textarea cols="6" rows="8" name="email_temp_details" id=""  class="form-control my_texteditor"><?php echo "" . esc_textarea($template_body); ?></textarea>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12">
                <?php wp_nonce_field('email_temp_nonce_action', 'email_temp_nonce'); ?>
