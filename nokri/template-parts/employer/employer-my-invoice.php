...
$adress2 = $data['billing']['address_2'];
...
if ($order_status == 'processing') {
    ...
    $order_status_pend = esc_html__('Completed', 'nokri');
} else {
...
<div class="main-body">
                    ...
                    <div class="order-invoice-to">
                        ...
                        <address class="order-invoice-to-info">
                           <p><?php echo esc_html($adress); ?></p>
                            <p><?php echo esc_html($adress2)?></li></p>
                        </address>
                        ...
                        <table class="table order-invoice-items">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo esc_html(wc_price($subtotal)); ?></td>               
                                </tr>
                                <?php if (wc_tax_enabled()) { ?> 
                                    <tr>
                                        <td></td>
                                        <td><?php echo esc_html__('VAT', 'nokri'); ?></td>                 
                                        <td><?php echo esc_html(wc_price($cart_tax)); ?>                
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td><span class="order-invoice-footer-total-amount"><?php echo esc_html(wc_price($order_total)); ?></span></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <a href="#" class="btn n-btn-flat float-end <?php echo esc_attr($rtl_class); ?>" onclick="printDiv('printableArea')"><?php echo esc_html__('Print', 'nokri'); ?></a>
    </div>
</div>
<script>
