            ...
            if ($is_pkg_exired != 're' && $is_pkg_exired != 'pe' && $is_pkg_exired != 'np') {
                ...
                if (count($class_terms) > 0) {
                    ...
                    foreach ($class_terms as $class_term) {
                        ...
                        $term_id = nokri_get_origional_term_id($class_term->term_id);
                        ...
                        $package_html .= '<div class="posted-job-list">
									<ul class="list-inline">
										<li class="package-id">' . esc_html($count) . '</li>
										<li class="package-title">' . esc_html(ucfirst($class_term->name)) . esc_html($jobs) . '</li>
										<li class="package-action">' . esc_html($class) . '</li>
									</ul>
								</div>';
                        $count++;
                    }
                ...
                <?php
                echo '' . wp_kses($package_html, get_allowed_html_tags());
