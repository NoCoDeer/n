...
$c_order   	= isset($_GET['c_order']) && $_GET['c_order'] != ""    ?  sanitize_text_field($_GET['c_order'])    :   '';
$job_id   	= isset($_GET['id'])      && $_GET['id']      != ""    ?  sanitize_text_field($_GET['id'])         :   '';
    ...
    <input type="hidden" name="id" value="<?php echo  esc_attr($job_id); ?>" >
        ...
        <div class="col-md-6 col-xs-12 col-sm-6">
            <div class="form-group custom-form-group">
                ...
                <input type="text" value="<?php echo esc_html($c_name); ?>" <?php if ( $order == 'ASC') { echo esc_attr("selected"); } ; ?> class="form-control" name="c_name" placeholder="<?php echo  esc_html__( 'Keyword or Name', 'nokri' ); ?>">
        ...
        <div class="col-md-6 col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                <select class="js-example-basic-single emp_matched_resumes_form" name="c_order">
                    ...
                    <option value="ASC" <?php if ( $c_order == 'ASC') { echo esc_attr("selected"); } ; ?>><?php echo  esc_html__( 'ASC', 'nokri' ); ?></option>
                    <option value="DESC" <?php if ( $c_order == 'DESC') { echo esc_attr("selected"); } ; ?>><?php echo  esc_html__( 'DESC', 'nokri' ); ?></option>
                </select>
            </div>
        </div></div>
...
?>  
        ...
        <ul class="pagination">
            ...
            $allowed_html = array(
                ...
                'i' => array(
                    'class' => true,  // Allow class attribute in <i> tags (for Font Awesome icons)
                ),
            );
            
            
            echo wp_kses(nokri_user_pagination($pages_number,$page), $allowed_html);?> 
        </ul>
        </div>
    </div>
</div>
...
<div class="dashboard-job-filters">
    <div class="row">
    <form method="GET" id="emp_matched_resumes_form abc">
    <input type="hidden" name="tab-data" value="match-list" >
    <input type="hidden" name="id" value="<?php echo  esc_attr($job_id); ?>" >
        <div class="row">
        <div class="col-md-6 col-xs-12 col-sm-6">
