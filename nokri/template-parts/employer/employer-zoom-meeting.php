...
?>   
<form method="post"  class="nokri_zoom_auth"<?php echo '' . esc_attr($alredy_auth ? ' style="display: none;"' : '') ?>>
    <div class="main-body"> 
            ...
            <div class="dashboard-edit-profile"> 
                ...
                <div class="col-md-12 col-xs-12 col-sm-6">            
                    <div class="form-group">
                        ...
                        <input type="text" name="sb_zoom_email" value="<?php echo '' . ($user_zoom_email) ?>" placeholder="<?php esc_attr__('Enter Zoom Registerd Email', 'nokri') ?>"  class="form-control">
                    </div> 
                </div>
                <div class="col-md-12 col-xs-12 col-sm-6">
                    <div class="form-group">
                        <span><?php esc_html_e('Zoom Client ID', 'nokri') ?></span>
                        <input type="text" name="nokri_sb_client_id" value="<?php echo ''.($user_client_id); ?>" placeholder="<?php esc_attr__('Enter Zoom Client ID', 'nokri') ?>"  class="form-control">
                    </div>
                    
                        <div class="form-group">
                            <span><?php esc_html_e('Client Secret Key', 'nokri') ?></span>
                            <input type="text" name="sb_client_secret" value="<?php echo '' . ($user_client_secret) ?>" placeholder="<?php esc_attr__('Enter Client Secret Key', 'nokri') ?>"  class="form-control">
                        </div> 
                    
                </div>
            </div>
            <div>
                <input type="submit" id="btn_zoom" class="btn n-btn-flat" value="<?php echo esc_attr__('Authorization with Zoom', 'nokri') ?>">
            </div>
