...
if (isset($is_member) && $is_member != '') {
    if ($is_member == 1) {
        ...
        <form id="sb-emp-profile" method="post">
            <?php wp_nonce_field('emp_profile_nonce_action', 'emp_profile_nonce'); ?>
            <div class="main-body">
                <div class="dashboard-edit-profile">
                    ...
                    <div class="dashboard-social-links">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" value="<?php echo esc_attr($user_info->display_name); ?>" data-parsley-required="true" data-parsley-error-message="<?php echo esc_attr__('This field is required.', 'nokri'); ?>" name="emp_name" class="form-control">
                            </div>
                        </div>
                        <?php if (nokri_feilds_operat('emp_heading_setting', 'show')) { ?>
                            <div class="col-md-6 col-xs-12 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_user_headline', true)); ?>" name="emp_headline" class="form-control" placeholder="<?php echo nokri_feilds_label('emp_heading_plc', esc_attr__('Headline', 'nokri')); ?>" <?php echo nokri_feilds_operat('emp_heading_setting', 'required'); ?> data-parsley-error-message="<?php echo esc_attr__('This field is required.', 'nokri'); ?>">
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" disabled placeholder="<?php echo '' . esc_attr($user_info->user_email); ?>"  name="emp_email" class="form-control">
                            </div> 
                        </div>
                        <?php if (nokri_feilds_operat('emp_phone_setting', 'show')) { ?>
                            <div class="col-md-6 col-xs-12 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sb_reg_contact" data-parsley-error-message="<?php echo esc_attr__('Should be in digits with out space', 'nokri'); ?>"   placeholder="<?php echo nokri_feilds_label('emp_phone_plc', esc_attr__('Company Phone', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_sb_contact', true)); ?>" class="form-control" <?php echo nokri_feilds_operat('emp_phone_setting', 'required'); ?>>
                                </div>
                            </div>
                        <?php } if (nokri_feilds_operat('emp_web_setting', 'show')) { ?>
                            <div class="col-md-6 col-xs-12 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" data-parsley-error-message="<?php echo esc_attr__('Should be in url', 'nokri'); ?>" data-parsley-type="url"   placeholder="<?php echo nokri_feilds_label('emp_web_plc', esc_attr__('Company Web Url', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_web', true)); ?>" name="emp_web" class="form-control" <?php echo nokri_feilds_operat('emp_web_setting', 'required'); ?>>
                                </div>
                            </div>
                        ...
                        <?php } if (nokri_feilds_operat('emp_about_setting', 'show')) { ?>
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea  name="emp_intro" class="form-control emp_intro_det" id="up_emp_intro"  cols="30" rows="10"><?php echo esc_html(nokri_candidate_user_meta('_emp_intro')); ?></textarea>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                                    ...
                                    <div class="dashboard-location">
                                        ...
                                        ?>>
                                            <div class="mb-3" >
                                                ...
                                                <select class="js-example-basic-single" data-allow-clear="true" data-placeholder="<?php echo esc_attr__('Select State', 'nokri'); ?>" id="ad_country_states" name="cand_country_states">
                                        ...
                                        ?>>
                                            <div class="mb-3">
                                                ...
                                                <select class="js-example-basic-single" data-allow-clear="true" data-placeholder="<?php echo esc_attr__('Select City', 'nokri'); ?>" id="ad_country_cities" name="cand_country_cities">
                                        ...
                                        ?>>
                                            <div class="mb-3">
                                                ...
                                                <select class="js-example-basic-single" data-allow-clear="true" data-placeholder="<?php echo esc_attr__('Select Town', 'nokri'); ?>" id="ad_country_towns" name="cand_country_towns">
                    ...
                    <!-- Company Locations-->
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <input type="submit" id="emp_save" value="<?php echo esc_attr('Save Profile', 'nokri'); ?>" class="btn n-btn-flat">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <?php if ($is_acount_del) { ?>
                                <input type="button" value="<?php echo esc_attr__('Delete account?', 'nokri'); ?>" class="btn btn-custom del_acount">
                            <?php } ?>
                            <input type="submit" value="<?php echo esc_attr__('Processing...', 'nokri'); ?>" class="btn n-btn-flat cand_pass_pro">
                    ...
                    if (nokri_feilds_operat('emp_phone_setting', 'show')) {
                        ...
                        if ($fbAllowed == true) {
                            ...
                            if ($phoneNo == '' && $verified_pho == '') {
                                ?>                               
                                <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12 numberr_field">
                                    <div class="mb-3">
                                ...
                                <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12 codee_field">
                                    <div class="mb-3">
   ...
   <input id="input-b1" name="my_cover_upload[]" type="file" class="file form-control sb_cover-data input-b2" data-show-preview="false" data-allowed-file-extensions='["jpg", "png", "jpeg"]' data-show-upload="false">
                    ...
                    <?php } if (nokri_feilds_operat('emp_about_setting', 'show')) { ?>
                        <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="mb-3">
                                <label class=""><?php echo nokri_feilds_label('emp_about_label', esc_html__('About yourself', 'nokri')); ?></label>
                                <textarea  name="emp_intro" class="form-control my_texteditor" id=""  cols="30" rows="10"><?php echo esc_html(nokri_candidate_user_meta('_emp_intro')); ?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
                            ...
                            <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select class="select-generat form-control" name="emp_cat[]" id="change_term" multiple="multiple">
                                        <?php echo wp_kses(nokri_candidate_skills('emp_specialization', '_emp_skills'), array(
                                            'option' => array(
                                                'value' => true,
                                                'selected' => true,
                                            ),
                        ...
                        <?php } if (nokri_feilds_operat('emp_no_emp_setting', 'show')) { ?>
                            <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="<?php echo nokri_feilds_label('emp_no_emp_plc', esc_attr__('Enter number of employes', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_nos', true)); ?>"  name="emp_nos" class="form-control" <?php echo esc_attr(nokri_feilds_operat('emp_no_emp_setting', 'required')); ?> data-parsley-error-message="<?php echo esc_attr($req_mess); ?>">
                                </div>
                            </div>
                        <?php } if (nokri_feilds_operat('emp_est_setting', 'show')) { ?>
                            <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_est', true)); ?>" name="emp_est" class="datepicker-here-canidate form-control" <?php echo esc_attr(nokri_feilds_operat('emp_est_setting', 'required')); ?> />
                                </div>
                            </div>
                            ...
                            <?php if (nokri_feilds_operat('emp_fb_setting', 'show')) { ?>
                                <div class="col-xxl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="<?php echo nokri_feilds_label('emp_fb_plc', esc_attr__('Profile URL', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_fb', true)); ?>" name="emp_fb" class="form-control" <?php echo nokri_feilds_operat('emp_fb_setting', 'required'); ?> data-parsley-error-message="<?php echo esc_attr($req_mess); ?>">
                                    </div>
                                </div>
                            <?php } if (nokri_feilds_operat('emp_twtr_setting', 'show')) { ?>
                                <div class="col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="<?php echo nokri_feilds_label('emp_twtr_plc', esc_attr__('Profile URL', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_twitter', true)); ?>" name="emp_twitter" class="form-control" <?php echo nokri_feilds_operat('emp_twtr_setting', 'required'); ?> data-parsley-error-message="<?php echo esc_attr($req_mess); ?>">
                                    </div>
                                </div>
                            <?php } if (nokri_feilds_operat('emp_linked_setting', 'show')) { ?>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="<?php echo nokri_feilds_label('emp_linked_plc', esc_attr__('Profile URL', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_linked', true)); ?>" name="emp_linked" class="form-control" <?php echo nokri_feilds_operat('emp_linked_setting', 'required'); ?> data-parsley-error-message="<?php echo esc_attr($req_mess); ?>">
                                    </div>
                                </div>
                            <?php } if (nokri_feilds_operat('emp_insta_setting', 'show')) { ?>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="<?php echo nokri_feilds_label('emp_insta_plc', esc_attr__('Profile URL', 'nokri')); ?>" value="<?php echo esc_attr(get_user_meta($user_crnt_id, '_emp_google', true)); ?>" name="emp_google" class="form-control" <?php echo nokri_feilds_operat('emp_insta_setting', 'required'); ?> data-parsley-error-message="<?php echo esc_html($req_mess); ?>">
                                    </div>
                                </div>
                            <?php } ?>
                            </div>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                <?php wp_nonce_field('emp_profile_nonce_action', 'emp_profile_nonce'); ?>
                    <input type="submit" id="emp_save" value="<?php echo esc_attr__('Save Profile', 'nokri'); ?>" class="btn n-btn-flat">
                    <button class="btn n-btn-flat" type="button" id="emp_proc" disabled><?php echo esc_html__('Processing...', 'nokri'); ?></button>
                    <button class="btn n-btn-flat" type="button" id="emp_redir" disabled><?php echo esc_html__('Redirecting...', 'nokri'); ?></button>
                </div>
            </div>
        ...
        if ($is_permiss) {
            ...
            <div class="main-body change-password">
                <div class="dashboard-edit-profile">
                    ...
                    <div class="row">
                        <div class="team-member-grids row">
                            <?php
                            if (is_array($final_data) && !empty($final_data)) {
                                ...
                                foreach ($final_data as $key => $data) {
                                    ...
                                    ?>
                                    <div class="col-lg-4 col-md-4 col-sm-12 <?php echo esc_attr($key); ?>">
                                        <figure class="team-grid">
                                            ...
                                            <div class="team-footer">
                                                ...
                                                <span class="list">
                                                <?php wp_nonce_field('delete_member_nonce_action', 'delete_memder_nonce') ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 <?php echo esc_attr($key); ?>">
                                        <figure class="team-grid">
                                            ...
                                            <div class="team-footer">
                                                ...
                                                <span class="list">
                                                    <?php wp_nonce_field('delete_account_member_nonce_action', 'delete_account_memder_nonce'); ?>
        ...
        <?php } if ($port_sec) { ?>
            <div class="main-body change-password">
                <div class="dashboard-edit-profile">
                                ...
                                <?php } if (nokri_feilds_operat('emp_port_vid_setting', 'show')) { ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" placeholder="<?php echo nokri_feilds_label('emp_port_vid_plc', esc_attr__('Put youtube video link', 'nokri')); ?>" value="<?php echo esc_attr(nokri_candidate_user_meta('_emp_video')); ?>" name="emp_video" class="form-control" data-parsley-pattern="^(http(s)?:\/\/)?((w){3}.)?youtu(be|.be)?(\.com)?\/.+" <?php echo nokri_feilds_operat('emp_port_vid_setting', 'required'); ?> >
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <input type="submit"  value="<?php echo esc_attr__('Save Profile', 'nokri'); ?>" class="btn n-btn-flat">
                </div>
            </div>
        <?php } ?>
