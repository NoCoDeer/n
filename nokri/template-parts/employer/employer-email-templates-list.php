						...
						<ul class="list-inline">
							...
							<li class="posted-job-action"> 
								<ul class="list-inline">
									...
									<li class="tool-tip del_email_template" data-tempId="'.esc_attr($key).'"  title="'.esc_html__( 'Delete', 'nokri' ).'">'. wp_nonce_field('del_email_temp_nonce_action', 'del_email_temp_nonce') .'<a href="#" class="label label-danger"> <i class="ti-trash"></i></a></li>
								</ul>
							</li>
						</ul>
					</div>';
