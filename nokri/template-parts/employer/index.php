...
if ($query->have_posts()) {
    ...
    while ($query->have_posts()) {
        ...
        if (class_exists('Post_Views_Counter')) {
            $job_views = (int) pvc_post_views($post_id = $job_id, '');
            $job_views = esc_html__('Post Views ', 'nokri') . $job_views;
        }
        $job_html .= '<tr>
			<td><a href="' . esc_url(get_the_permalink()) . '">' . esc_html(get_the_title($job_id)) . '</a></td>
			<td><span class="label label-' . esc_attr($class) . '">' . esc_html($post_status) . '</span></td>
			<td>' . esc_html($resume_counts) . '</td>
			<td>' . esc_html($job_views) . '</td>
                    </tr>';
    }
    wp_reset_postdata();
}
                            ...
                            <div class="stat-box parallex">
                                <div class="stat-box-meta">
                                    ...
                                    <div class="stat-box-meta-icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/job1.png'); ?>" class="img-responsive" alt="<?php echo esc_attr__('image', 'nokri'); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="stat-box blue">
                                <div class="stat-box-meta">
                                    <div class="stat-box-meta-text">
                                        ...
                                        <h3><?php echo esc_html(nokri_get_jobs_count($user_id, 'pending')); ?></h3>
                                    </div>
                                    <div class="stat-box-meta-icon">
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/warning.png'); ?>" class="img-responsive" alt="published jobs">
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="stat-box parallex">
                        ...
                        <p><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=active-jobs');?>"><?php echo esc_html__('View All Published Jobs', 'nokri'); ?></a></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="stat-box blue">
                        ...
                        <p><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=pending-jobs');?>"><?php echo esc_html__('View All Pending Jobs', 'nokri'); ?></a></p>
                    </div>
                </div>
            </div>     
        </div>
        ...
        <div class="custom_counter table-responsive dashboard-job-stats-table">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="counter">
                    ...
                    <h5><p class="count-text "><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=active-jobs');?>"><?php echo esc_html__('Published Jobs', 'nokri'); ?></a></p></h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="counter">
                    ...
                    <h5><p class="count-text "><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=pending-jobs');?>"><?php echo esc_html__('Pending Jobs', 'nokri'); ?></a></p></h5>              
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="counter">
                    ...
                    <h5><p class="count-text "><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=saved-resumes');?>"><?php echo esc_html__('Saved Resumes', 'nokri'); ?></a></p></h5>
                </div></div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="counter">
                    <i class="fa fa-bell-o fa-2x"></i>
                    <h2 class="timer count-title count-number" data-to="<?php echo esc_attr($emp_followers != '' ? $emp_followers : 0); ?>" data-speed="1500"></h2>
                    <h5><p class="count-text "><a href="<?php echo esc_url(get_the_permalink() . '?tab-data=our-followers');?>"><?php echo esc_html__('Followers', 'nokri'); ?></a></p></h5>
                </div>
            </div>
		</div>
        </div>
