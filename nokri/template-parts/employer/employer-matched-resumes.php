    ...
    <input type="hidden" name="form" >
        ...
        <div class="col-md-4 col-sm-12">
            <div class="form-group custom-form-group">
                ...
                <input type="text" name="job_name" class="form-control" placeholder="<?php echo esc_attr__( 'Keyword or tag', 'nokri' ); ?>" value="<?php echo esc_html($job_name); ?>">
        ...
        <div class="col-md-4  col-sm-12">
            <div class="mb-3">
                ...
                <select name="job_class" class="select-generat form-control emp_matched_resumes">
                   ...
                   <?php echo wp_kses(nokri_job_post_taxonomies('job_class',$job_class),get_allowed_html_tags()); ?>
                </select>
            </div>
        </div>
        <div class="col-md-4  col-sm-12">
