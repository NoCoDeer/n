...
<div class="main-body">
    <div class="dashboard-job-stats followers">
        ...
        <div class="dashboard-posted-jobs">
            ...
            if (isset($cand_followers) && count($cand_followers) > 0) {
                ...
                foreach ($cand_followers as $follower) {
                    ...
                    $follower_img_html = '';
                     if (is_array($image_dp_link) && !empty($image_dp_link[0])) {
		...
		<ul class="list-inline">
			<li class="resume-id">' . esc_html($count) . '</li>
            ...
            '. wp_nonce_field('unfollow_cands_nonce_action', 'unfollow_cands_nonce') .'
				<a href="#" class="btn btn-custom unfollow_cands"  data-id="' . esc_attr($follower_id) . '"> ' . esc_html__('Remove', 'nokri') . ' </a>
			</li>
