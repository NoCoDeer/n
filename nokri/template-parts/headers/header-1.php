...
if (wp_basename(get_page_template()) == 'page-dashboard.php' || $is_map) {
    ...
    $header_font_clr = '';
    $emp_style2 = ( isset($nokri['emp_profile_style']) && $nokri['emp_profile_style'] != "" ) ? $nokri['emp_profile_style'] : "2";
    if ($emp_style2 == '2') {
        $header_font_clr = 'n-new-change-header';
    }
    $dashboard_class = 'fa-change-black n-header-trabsparent ' . $header_font_clr;
    $dashboard_fluid = '';
...
<div class="transparent-header-1">
    <nav id="menu-1" class="mega-menu <?php echo esc_attr($dashboard_class) . " " . esc_attr($bread_class); ?>" <?php
                ...
                if ((isset($nokri['user_bar_switch'])) && $nokri['user_bar_switch'] == '1') {
                    if (is_user_logged_in()) {
                       ...
                       <li class="nav-item dropdown profile-pic">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo esc_url($image_dp_link[0]); ?>" alt="<?php echo esc_attr__("image", "nokri"); ?>" class="img-fluid rounded-circle" width="36">
                    ...
                    <?php
                        ...
                        if ($current_id == $usercheck) {
                            echo '<li><a href="' . esc_url(get_the_permalink($job_link)) . '"class="btn n-btn-flat"><i class="' . esc_attr($bnt_class) . '"></i>' . esc_html($job_button) . '</a></li>';
                        ...
                        ?>
                        <li>
                            <a href="<?php echo esc_url(get_the_permalink($signin)); ?>" class="n-login-header"><i class="fa fa-sign-in"></i><?php echo esc_html__('Login', 'nokri'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(get_the_permalink($signup)); ?>" class="n-login-header"><i class="fa fa-user-plus"></i><?php echo esc_html__('Register', 'nokri'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(get_the_permalink($wo_link)); ?>" class="btn n-btn-flat"><i class="<?php echo esc_attr($wo_icon); ?>"></i><?php echo esc_html($wo_txt); ?></a>
                        </li>
                        <?php
                    }
                }
