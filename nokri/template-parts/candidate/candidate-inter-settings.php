        ...
        <div class="dashboard-edit-profile">
            ...
            <div class="row">                
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_phone_setting" >
                            ...
                            if ($cand_phone_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_phone_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                            if ($cand_phone_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_email_setting" >
                            <option value="other" <?php
                            if ($cand_email_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_email_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                            if ($cand_email_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                ...
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_adress_setting" >
                            <option value="other" <?php
                            if ($cand_adress_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_adress_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                            if ($cand_adress_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                ...
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_dob_setting" >
                            <option value="other" <?php
                            if ($cand_dob_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_dob_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                ...
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_save_setting" >
                            <option value="other" <?php
                            if ($cand_save_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_save_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                            if ($cand_save_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                ...
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_resume_setting" >
                            <option value="other" <?php
                            if ($cand_resume_setting == 'other') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value="yes" <?php
                            if ($cand_resume_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value="no" <?php
                            if ($cand_resume_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                ...
                <div class="col-md-6 col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select  class="select-generat form-control" name="cand_generate_setting" >
                            <option value ="other" <?php
                            if ($cand_generate_setting == '') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Select option', 'nokri'); ?></option>
                            <option value ="yes" <?php
                            if ($cand_generate_setting == 'yes') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('Yes', 'nokri'); ?></option>
                            <option value ="no" <?php
                            if ($cand_generate_setting == 'no') {
                                echo esc_attr("selected");
                            }
                            ?>><?php echo esc_html__('No', 'nokri'); ?></option>
                        </select>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <input type="submit" value="<?php echo esc_attr__('Save Settings', 'nokri'); ?>" class="btn n-btn-flat cand_settings_save">
