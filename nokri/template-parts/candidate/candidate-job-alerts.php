            ...
            ?>
                    <div class="posted-job-list resume-on-jobs" id="alert-box-<?php echo esc_attr($key); ?>">
                        <ul class="list-inline">
                            ...
                            <?php wp_nonce_field('del_save_alert_nonce_action', 'del_save_alert_nonce') ?>
                ...
                <div class="notification-box">
                    <a href="javascript:void(0)" class="btn n-btn-flat job_alert"><?php echo esc_html__('Add Jobs Alert', 'nokri'); ?> </a>
                </div>
        </div>
    </div>
</div>
