...
{
	 $user_crnt_id	=	sanitize_text_field($_GET['cid']);
}
else 
{
    ...
    <div class="main-profile-card">
        <div class="contact-box">
            <div class="contact-img">
                <img src="<?php echo esc_url($image_link[0]); ?>" class="img-responsive img-circle" alt="<?php echo esc_attr__( 'candidate profile image', 'nokri' ); ?>">
            </div>
            <div class="contact-caption">
                <h4><?php echo esc_html($user_info->display_name); ?></h4>
                <span><?php echo  esc_html(nokri_candidate_user_meta('_user_headline')); ?></span>
            </div>
            <ul class="social-links list-inline">
                <?php if(get_user_meta($user_crnt_id, '_cand_fb', true) != '') { ?>
                <li> <a href="<?php echo  esc_url(get_user_meta($user_crnt_id, '_cand_fb', true)); ?> " target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/006-facebook.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
                <?php } if(get_user_meta($user_crnt_id, '_cand_twiter', true) != '') { ?>
                <li> <a href="<?php echo  esc_url(get_user_meta($user_crnt_id, '_cand_twiter', true)); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/004-twitter.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
                <?php } if(get_user_meta($user_crnt_id, '_cand_google', true) != '') { ?>
                <li> <a href="<?php echo  esc_url(get_user_meta($user_crnt_id, '_cand_google', true)); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/003-google-plus.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
                <?php } if(get_user_meta($user_crnt_id, '_cand_linked', true) != '') { ?>
                <li> <a href="<?php echo  esc_url(get_user_meta($user_crnt_id, '_cand_linked', true)); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/005-linkedin.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></a></li>
                 <?php } ?>
            </ul>
        </div>
        <div class="resume-detail">
                            ...
                            <ul>
                            <li>
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/011-calendar.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
                            <div class="resume-detail-meta"><small><?php echo esc_html__( 'Member Since:', 'nokri' ); ?></small> <strong><?php echo  date( "M Y", strtotime( $registered ) ) ; ?></strong></div>
                                ...
                                <li><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/012-man.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
                                ...
                                <li><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/009-phone-receiver.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
                                ...
                                <?php }  ?>
                                <li><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/008-email.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
                                ...
                                <li><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/007-placeholder.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
    ...
    /* Checking Education*/
     ...
     if ( $cand_education  && $cand_education[0]['degree_name'] != '' ) {  ?>
        <div class="resume-box">
            ...
            <p><?php echo  esc_html(get_user_meta($user_crnt_id, '_cand_intro', true));?></p>
            <?php } ?>
        </div>
         <?php if(!empty($skill_tags)) { ?>
        <div class="resume-box">
    <div class="timeline-box">
    <img class="heading-icon" src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/010-skills.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>"></i>
        ...
        <div class="resume-box">
            <div class="timeline-box">
            <img class="heading-icon" src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/013-graduation-hat.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
        ...
        <div class="resume-box">
            <div class="timeline-box">
            <img class="heading-icon" src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/015-google-plus.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
...
$project_detail	= (isset($profession['project_desc']))  ? '<div class="info">'.$profession['project_desc'].'</div>'   :   '';				
        ...
        if ( $cand_certifications  && $cand_certifications[0]['certification_name'] != '') { ?>
                    <div class="resume-box">
                        <div class="timeline-box">
                        <img class="heading-icon" src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/002-medal.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
...
$certi_inst	= (isset($certification['certification_institute']))? '<div class="type ">'.esc_html($certification['certification_institute']).$certi_durat.'<div>' :   '';
$certi_strt	= (isset($certification['certification_start']))  ? esc_html($certification['certification_start'])   :   '';
$certi_detail	= (isset($certification['certification_desc']))  ? '<div class="info">'.esc_html($certification['certification_desc']).'</div>'   :   '';
                                             ?>
                                                <li><span></span>
                                                    <div>
                                      <div class="date"><?php echo esc_html($certi_strt)." "; 
                        ...
                        <div class="resume-box">
                        <div class="timeline-box">
                         <img class="heading-icon" src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/portfolio.png'); ?>" alt="<?php echo esc_attr__( 'icon', 'nokri' ); ?>">
