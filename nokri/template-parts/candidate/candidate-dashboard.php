...
if (isset($_GET['candidate-page']) && $_GET['candidate-page'] != "") {
    $candidate_page = sanitize_text_field($_GET['candidate-page']);
} else {
...
<section class="dashboard-new candidate-dashboard <?php echo esc_attr($emp_dashboard); ?> <?php echo esc_attr($top_bar_class); ?>">
    <div class="container-fluid">
        <div class="col-xxl-12 col-md-12 col-sm-12 nopadding">
            <div class="row">
                <?php
                if (isset($_GET['candidate-page']) && $_GET['candidate-page'] == "my-profile") {
                    ...
                    ?>
                    <div class="col-lg-2 col-md-3 col-sm-2 col-xs-12 order-lg-0 nopadding">
                        <div class="profile-menu">
                            <div class="menu-avtr-box">
                                <div class="user-img">
                                    <img src="<?php echo esc_url($image_dp_link[0]); ?>" id="candidate_dp" class="img-responsive"   alt="<?php echo esc_attr__('candidate profile image', 'nokri'); ?>"> 
                                </div>
                                <div class="user-text">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 order-lg-2 p-0 order-lg-2 nopadding">
                        <div class="theiaStickySidebar">
                            <div class="main-profile-card">
                                <div class="contact-box">
                                    <div class="contact-img">

                                        <img src="<?php print_r($image_dp_link[0]);?>" id="candidate_dp" class="img-responsive img-circle" alt="<?php echo esc_attr__('candidate profile image', 'nokri'); ?>">
                                    </div>
                                    <div class="contact-caption">
                                        ...
                                        <span><?php echo esc_html(get_user_meta($user_crnt_id, '_user_headline', true)); ?></span>
                                    </div>
                                    <ul class="social-links list-inline">
                                        <?php if (get_user_meta($user_crnt_id, '_cand_fb', true) != '') { ?>
                                            <li> <a href="<?php echo nokri_candidate_user_meta('_cand_fb'); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/006-facebook.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                        <?php } if (get_user_meta($user_crnt_id, '_cand_twiter', true) != '') { ?>
                                            <li> <a href="<?php echo nokri_candidate_user_meta('_cand_twiter'); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/004-twitter.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                        <?php } if (get_user_meta($user_crnt_id, '_cand_google', true) != '') { ?>
                                            <li> <a href="<?php echo nokri_candidate_user_meta('_cand_google'); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/003-google-plus.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                        <?php } if (get_user_meta($user_crnt_id, '_cand_linked', true) != '') { ?>
                                            <li> <a href="<?php echo nokri_candidate_user_meta('_cand_linked'); ?>" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/resume-detail-icons/005-linkedin.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                        <?php } ?>
                                    </ul>
                                    <?php if ($percaentage_switch) { ?>
                                        <div class="progress-bar-section">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" style="width: <?php echo esc_attr($profile_percent); ?>%;" aria-valuenow="<?php echo esc_attr($profile_percent); ?>" aria-valuemin="0" aria-valuemax="100">
                                                    <span data-percent="<?php echo esc_attr($profile_percent); ?>" class="profile<?php echo esc_attr($profile_percent); ?>"></span>
                                                </div>
                                            </div>
                                            <div class="progress-bar-title">
                                                <h5><?php echo esc_html__('Profile Percent', 'nokri'); ?></h5>
                                                <span class="progress-percentage"><?php echo esc_html($profile_percent); ?>%</span>
                                            </div>
                            ...
                            <?php if (isset($nokri['cand_resume_gen_dashboard']) && $nokri['cand_resume_gen_dashboard']) { ?>
                                <a class="btn n-btn-flat btn-block w-100" href="#" data-bs-toggle="modal" data-bs-target="#template_modal" > <?php echo esc_html__('Generate Resume', 'nokri') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-12 col-sm-12 order-lg-1">
                        <?php
                        if ($candidate_page != "") {
                            get_template_part('template-parts/candidate/candidate', $candidate_page);
                        } else {
