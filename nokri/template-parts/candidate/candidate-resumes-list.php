								...
								<ul class="list-inline">
									...
									<li class="posted-job-title">
										<div class="posted-job-title-meta">
											<a href="javascript:void(0)">' . esc_html(basename(get_attached_file($resume))) . '</a>
										</div>
									</li>
                                    ...
                                    '. wp_nonce_field('del_my_resume_nonce_action', 'del_my_resume_nonce') .'
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <div class="file-upload-wrapper" data-text="<?php echo esc_attr__("Click to upload", "nokri"); ?>">
