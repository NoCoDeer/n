    ...
    <ul class="list-inline">
        ...
        <?php if (esc_url($image_link[0])) { ?>
            <div class="posted-job-title-img">
                <a href="<?php echo esc_url(get_the_permalink()); ?>"><img src="<?php echo esc_url($image_link[0]); ?>" class="img-responsive img-circle" alt="<?php echo esc_attr__( 'company image', 'nokri' ); ?>"></a>
            </div>
            <?php } ?> 
            <div class="posted-job-title-meta">
                <a href="<?php echo esc_url(get_the_permalink()); ?>"><?php echo esc_html__(get_the_title()); ?> </a>
        ...
        <li class="posted-job-expiration"><?php echo "".esc_html($job_deadline); ?></li>
        <li class="posted-job-action"> 
        <?php wp_nonce_field('del_saved_job_nonce_action', 'del_saved_job_nonce') ?>
