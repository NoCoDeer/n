...
$get_jobs = nokri_applied_jobs($user_crnt_id);
$applied_jobs = count((array) $get_jobs );
//nokri_wpml_show_all_posts_callback($args);
                ...
                <div class="stat-box parallex">
                    <div class="stat-box-meta">
                        ...
                        <div class="stat-box-meta-icon">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/applied-jobs.png'); ?>" class="img-responsive" alt="<?php echo esc_attr__('applied jobs', 'nokri'); ?>">
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="stat-box blue">
                    <div class="stat-box-meta">
                        ...
                        <div class="stat-box-meta-icon">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/followers.png'); ?>" class="img-responsive" alt="<?php echo esc_attr__('followed companies', 'nokri'); ?>">
                        </div>
                    </div>
...
<?php } ?>
    ...
    <div class="n-candidate-meta">
        ...
        <?php if ($intro) { ?>
            <?php echo '' . wp_kses($intro, get_allowed_html_tags()); ?>
            ...
            <div class="timeline-box">
                ...
                <ul class="education">
                    ...
                    foreach ($cand_education as $edu) {
                        ...
                        $degre_strt = (isset($edu['degree_start'])) ? esc_html($edu['degree_start'] ): '';
                        $degre_insti = (isset($edu['degree_institute'])) ? '<div class="type ">' . esc_html($edu['degree_institute']) . '</div>' : '';
                        $degre_details = (isset($edu['degree_detail'])) ? strip_tags($edu['degree_detail']) : '';
                        ?>
                        <li><span></span>
                            <div>
                                <div class="date"><?php
                                    ...
                                    ?></div>
                                <?php echo "" . ($degre_name) . ($degre_insti);
                                if (!empty($degre_details)) {
                                    echo '<div class="info">' . esc_html($degre_details) . '</div>';
                                }
                                ?>
                            </div>
                        </li>
            ...
            <div class="timeline-box">
                ...
                <ul class="education">
                    ...
                    foreach ($cand_profession as $profession) {
                        ...
                        $project_org = (isset($profession['project_organization'])) ? '<div class="type ">' . esc_html($profession['project_organization'] ). '<div>' : '';
                        $project_strt = (isset($profession['project_start'])) ? esc_html($profession['project_start']) : '';
                        $project_detail = (isset($profession['project_desc'])) ? strip_tags($profession['project_desc']) : '';
                        ?>
                        <li><span></span>
                            <div>
                                <div class="date"><?php
                                    ...
                                    ?></div>
                                <?php echo "" . ($project_role) . ($project_org);
                                if (!empty($project_detail)) {
                                    echo '<div class="info">' . esc_html($project_detail) . '</div>';
                                }
                                ?>
                ...
                <ul class="education">
                    ...
                    foreach ($cand_certifications as $certification) {
                        if ($certification['certification_name'] != '') {
                            ...
                            $certi_strt = (isset($certification['certification_start'])) ? ($certification['certification_start']) : '';
                            $certi_detail = (isset($certification['certification_desc'])) ?  strip_tags($certification['certification_desc']) : '';
                            ?>
                            <li><span></span>
                                <div>
                                    <div class="date"><?php
                                        ...
                                        ?></div>
                                    <?php echo "" . ($certi_name) . ($certi_inst); 
                                    if($certi_detail) {
                                        echo '<div class="info">' . esc_html($certi_detail) . '</div>' ;
                                    }
                                    ?> 
                                </div>
                            </li>
        ...
        if (!empty($cand_video)) {
            ...
            <div class="timeline-box">
                ...
                <div class="n-my-portfolio">
                    <iframe width="830" height="380" src="https://www.youtube.com/embed/<?php echo "" . esc_attr($cand_video); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
            </div>
            <?php
        }
