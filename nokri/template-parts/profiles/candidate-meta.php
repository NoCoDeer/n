...
$user_type = get_user_meta($current_user_id, '_sb_reg_type', true);
...
if ($search_mode == "2" && !$is_applied) {
    ...
    if ($is_search == false && $current_user_id != $author_id) {
        echo '<script>jQuery(document).ready(function($) { toastr.error("' . esc_html__("You are not allowed", 'nokri') . '", "", {timeOut: 6500,"closeButton": true, "positionClass": "toast-top-right"}); });</script>';
        echo esc_url(nokri_redirect(get_the_permalink($package_page)));
    }
}
                ...
                <!-- carousel slide -->
                    ...
                    <?php if (is_rtl()) { ?>
                        <div class="carousel-item active">
                            <a href="javascript:void(0)" data-id="4" class="generate_resume" data-cand-id="<?php echo esc_attr($user_crnt_id) ?>"> <img src="<?php echo esc_url(get_template_directory_uri() . '/template-parts/cv-templates/images/cv-4.png'); ?>" class="" ></a>
                        </div>
                    <?php } else { ?>
                        <div class="carousel-item active">
                            <a href="javascript:void(0)" data-id="1" class="generate_resume"  data-cand-id="<?php echo esc_attr($user_crnt_id) ?>"> <img src="<?php echo esc_url(get_template_directory_uri() . '/template-parts/cv-templates/images/cv-1.png'); ?>" class="" ></a>    
                        </div>
                        <div class="carousel-item">
                            <a href="javascript:void(0)" data-id="2" class="generate_resume"  data-cand-id="<?php echo esc_attr($user_crnt_id) ?>">  <img src="<?php echo esc_url(get_template_directory_uri() . '/template-parts/cv-templates/images/cv-2.png'); ?>" class="" ></a>     
                        </div>
                        <div class="carousel-item">
                            <a href="javascript:void(0)" data-id="3" class="generate_resume" data-cand-id="<?php echo esc_attr($user_crnt_id) ?>"> <img src="<?php echo esc_url(get_template_directory_uri() . '/template-parts/cv-templates/images/cv-3.png'); ?>" class="" ></a>
                        </div>
                        <div class="carousel-item">
                            <a href="javascript:void(0)" data-id="4" class="generate_resume" data-cand-id="<?php echo esc_attr($user_crnt_id) ?>"> <img src="<?php echo esc_url(get_template_directory_uri() . '/template-parts/cv-templates/images/cv-4.png'); ?>" class="" ></a>
                        </div>
