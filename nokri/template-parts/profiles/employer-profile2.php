...
if ((isset($nokri['main_header_style'])) && $nokri['main_header_style'] != '') {
    ...
    $emp_style_class = '';
    if ($header_style == '1') {
        $emp_style_class = 'n-cand-dtl-spacing';
    }
}
?>
<section class="n-candidate-detail <?php echo '' . esc_attr($emp_style_class) ?> spacing2">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-xs-12 col-sm-12">
                <aside class="n-sidebar-style resume-3-sidebar">
                    <div class="n-candidate-info">
                        <div class="n-candidates-detail-2">
