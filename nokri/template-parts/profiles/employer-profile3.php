...
<section class="n-candidate-detail light-blue">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 col-lg-offset-1 change-del-margin">
                <div class="n-details-employers3">
                    <div class="n-details-employers">
                        <div class="n-details-box-employers">
                            <div class="n-details-box-img">
                                <a href="javascript:void(0)"><img src="<?php echo esc_url($image_link[0]); ?>" class="img-responsive"></a>
                            </div>
                            <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>                     
                                <div class="n-details-box-text">
                                    <a href="javascript:void(0)"><h3><?php echo esc_html(the_author_meta('display_name', $user_id)); ?></h3></a>
                                    <?php
                                ...
                                <?php if ($soc_sec && $social_links || $author_id == $current_user_id) { ?>
                                    <ul class="n-details-groups n_socials n_custom iconss">
                                        <?php if ($emp_fb) { ?>
                        ...
                        <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>
                            <div class="n-details-groups">
                                ...
                                if (get_user_meta($current_user_id, '_sb_reg_type', true) == 0 && $follow_btn_switch) {
                                    ...
                                    if ($comp_follow) {
                                        ?>
                                        <li><a class="btn n-btn-flat"><?php echo esc_html__('Followed', 'nokri'); ?></a></li>
                                    <?php } else { ?>
                    ...
                    <div class="n-employers-details-w">
                        <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active custom-link" data-bs-toggle="tab" href="#home"><?php echo esc_html__('All Details', 'nokri'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link custom-link" data-bs-toggle="tab" href="#menu1"><?php echo esc_html__('All Jobs', 'nokri'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link custom-link" data-bs-toggle="tab" href="#menu2"><?php echo esc_html__('Ratings & Reviews', 'nokri'); ?></a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">      
                                <div id="home" class="tab-pane fade in active show">
                                    <div class="col-lg-12 col-sm-12 col-md-6">
                                        <div class="team-member-grids resume-3-box">
                                            <?php if (get_user_meta($user_id, '_emp_intro', true) != '' && nokri_feilds_operat('emp_about_setting', 'show')) { ?>
                                                ...
                                                <h3><?php echo nokri_feilds_label('emp_about_label', esc_html__('About Company:', 'nokri')); ?></h3>
                                                <?php
                                    ...
                                    <div class="col-lg-12 n-details-list">
                                        <h3><?php echo nokri_feilds_label('emp_det', esc_html__('Employer detail:', 'nokri')); ?></h3>
                                        <ul>
                                            <li>
                                                <div class="n-list-employs-img">
                                                    <i class="la la-calendar la-3x"></i>
                                                </div>
                                                <div class="n-list-employ-text">                                                          
                                                    <h3><?php echo nokri_feilds_label('emp_mem_sinc', esc_html__('Member since:', 'nokri')); ?></h3>
                                                    <p><strong><?php echo esc_html(date_i18n(get_option('date_format'), strtotime($registered))); ?></strong></p>
                                                </div>
                                            </li>
                                            <?php if ($emp_address) { ?>
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">
                                                        <h3><?php echo nokri_feilds_label('emp_loc_section_label', esc_html__('Location:', 'nokri')); ?></h3>
                                                        <p><?php echo esc_html($emp_address); ?></p>
                                                    </div>
                                                </li>                                                   
                                            <?php } if ($emp_size) {
                                                ?>
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">
                                                        <h3><?php echo nokri_feilds_label('emp_no_emp_label', esc_html__('Employees:', 'nokri')); ?></h3>
                                                        <p><?php echo esc_html($emp_size); ?></p>
                                                    </div>
                                                </li>                                                   
                                            <?php } if ($is_public && $author_id == $current_user_id) {
                                                ...
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">
                                                        <h3><?php echo nokri_feilds_label('emp_phone_label', esc_html__('Contact Number:', 'nokri')); ?></h3>
                                                        <p><a href="tel:<?php echo esc_attr($emp_cntct); ?>"><strong><?php echo esc_html($emp_cntct); ?></strong></a></p>
                                            ...
                                            <?php } if ($is_public || $author_id == $current_user_id) { ?>
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">
                                                        <h3><?php echo nokri_feilds_label('emp_email_label', esc_html__('Email Address:', 'nokri')); ?></h3>
                                                        <p><?php echo esc_html($author->user_email); ?></p>
                                                    </div>
                                                </li>
                                            <?php } if ($emp_web && nokri_feilds_operat('emp_web_setting', 'show')) { ?>
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">
                                                        <h3><?php echo nokri_feilds_label('emp_web_label', esc_html__('Website URL:', 'nokri')); ?></h3>
                                                        <p><?php echo esc_html($emp_web); ?></p>
                                                    </div>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                        ...
                                        <div class="team-member-grids resume-3-box">
                                            ...
                                            if ($is_access) {
                                                ...
                                                if (is_array($final_data) && !empty($final_data)) {
                                                    ...
                                                    <h3><?php echo esc_html__('Team Members', 'nokri'); ?> </h3>
                                                    <?php
                                    ...
                                    <div class="row">
                                        <?php if (!empty($emp_video)) { ?>
                                            <div class="col-lg-8 col-sm-12 col-md-6 col-xs-12">
                                                ...
                                                <h3 class="ms-botom"><?php echo nokri_feilds_label('emp_vid_lab', esc_html__('Employer Video:', 'nokri')); ?> </h3>
							  ...
							  ^(?:https?://)?                           # Optional protocol
							   ...
							   ([^&]{11})                               # Video id of 11 characters as capture group 1
								~x';
                                                    ...
                                                    $emp_video = $matches[1];
                                                    ?>
                                                    <iframe width="320" height="300" src="https://www.youtube.com/embed/<?php echo "" . esc_url($emp_video); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                                </div>
                                            </div>
                                        <?php } if ($port_sec && $portfolio_html) { ?>
                                            <div class="col-xs-12 col-lg-4 col-sm-12 col-md-6">
                                                <div class="row">

                                                    <div class="col-xs-12 col-lg-12 col-sm-12 col-md-12">
                                                        <h3 class="ms-botom "><?php echo nokri_feilds_label('emp_gall_lab', esc_html__('Employer Gallery:', 'nokri')); ?></h3>
                                                    </div>                                                  
                                                    <div class="n-candidate-info no_border">
                                                        <ul class="emp-gallery"><?php echo '' . ($portfolio_html); ?></ul>                                                       
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } if ($is_public_contact) { ?>
                                            <div class="ms-top col-lg-12 col-sm-12 col-xs-12 n-details-list">

                                                <form id="contact_form_email" method="POST" enctype="multipart/form-data">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                                        
                                                        <h3 class="ms-botom c"><?php
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <?php if ($nokri['google_recaptcha_key'] != "" && $contact_recaptcha) { ?>
                                                                ...
                                                                <div class="g-recaptcha mb-3" name="contact-recaptcha" data-sitekey="<?php echo esc_attr($nokri['google_recaptcha_key']); ?>">
                                                                </div>             
                                                            <?php } ?>
                                                        </div>
                                                        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                                            ...
                                                            <?php wp_nonce_field('contact_me_nonce_action', 'contact_me_nonce'); ?>
                                                                <button type="submit" class="btn n-btn-flat"><?php echo esc_html__('Message', 'nokri'); ?></button>
                                                            </div>
                                                        </div>   
                                                    </div>
                                                </form>
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    <div class="n-tab-listing">
                                        <?php if ($results->have_posts()) { ?>
                                            <div class="n-search-listing n-featured-jobs">
                                                <h3><?php echo nokri_feilds_label('emp_open_pos', esc_html__('Open positions:', 'nokri')); ?></h3>
                                                                ...
                                                                <div class="n-job-detail">
                                                                    <ul class="list-inline">
                                                                        <li class="n-job-title-box">
                                                                            <h4><a href="<?php echo esc_url(the_permalink($rel_post_id)); ?>" class="job-title"><?php echo esc_html(the_title()); ?></a></h4>
                                                                        ...
                                                                        <li class="n-job-btns">
                                                                            <a href="javascript:void(0)" class="btn n-btn-rounded apply_job" data-job-id="<?php echo esc_attr($rel_post_id); ?>" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo esc_html__('Apply now', 'nokri'); ?></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
