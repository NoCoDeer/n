                ...
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                                ...
                                <div class="n-details-box-text">
                                    <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>                                 
                                        ...
                                        if ($last_login_status == true) {
                                            echo '<p>' . esc_html__('Last login:', 'nokri') . ' ' . esc_html(get_last_login($user_id)) . ' ' . esc_html__('ago', 'nokri') . '</p>';
                                        } if ($emp_headline && nokri_feilds_operat('emp_heading_setting', 'show')) {
                                            ?>
                                ...
                                <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>
                                    <div class="n-details-groups">
                                        ...
                                        if (get_user_meta($current_user_id, '_sb_reg_type', true) == 0 && $follow_btn_switch) {
                                            ...
                                            if ($comp_follow) {
                                                ?>
                                                <li><a class=" n-btn-flat"><?php echo esc_html__('Followed', 'nokri'); ?></a></li>
                                            <?php } else { ?>

                                                <li><a  data-value="<?php echo esc_attr($author_id); ?>"  class="n-btn-flat btn-block follow_company"><?php echo esc_html__('Follow', 'nokri'); ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <div class="n-resume-box-details ">
                                            <div class=" resume-3-detail">
                                                <div class="n-4-resume resume-3-box">
                                                    ...
                                                    if ($is_access) {
                                                        ...
                                                        if (is_array($final_data) && !empty($final_data)) {
                                                            ?>
                                                            <div class="n-4-resume resume-3-box">
                                                                <h4><?php echo esc_html__('Team Members', 'nokri'); ?> </h4>
                                                                <?php
                                                                    ...
                                                                    <div class="n-job-single">
                                                                        ...
                                                                        <div class="n-job-detail">
                                                                            <ul class="list-inline">
                                                                                ...
                                                                                <li class="n-job-btns">
                                                                                    <a href="javascript:void(0)" class="n-btn-rounded apply_job" data-job-id="<?php echo esc_attr($rel_post_id); ?>" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo esc_html__('Apply now', 'nokri'); ?></a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            <div class="resume-3-sidebar n_widget">
                                    ...
                                    <?php if ($is_public_contact) { ?>
                                        ...
                                        <form id="contact_form_email" method="POST" enctype="multipart/form-data">
                                            ...
                                            <?php if ($nokri['google_recaptcha_key'] != "" && $contact_recaptcha) { ?>
                                                ...
                                                <div class="g-recaptcha custom-recaptch-size mb-3"  name="contact-recaptcha" data-sitekey="<?php echo esc_attr($nokri['google_recaptcha_key']); ?>">
                                                </div>             
                                                <?php
                                            }
                                            ...
                                            <button type="submit" class="n-btn-flat btn-mid btn-block contact_me"><?php echo esc_html__('Message', 'nokri'); ?></button>
                                        </form>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php if (!empty($emp_video)) { ?>
                                <h3 class="widget-heading"><?php echo nokri_feilds_label('emp_vid_lab', esc_html__('Employer Video:', 'nokri')); ?> </h3>
                            ...
                            <?php } if ($port_sec && $portfolio_html) { ?>
                                ...
                                <h3 class="widget-heading"><?php echo nokri_feilds_label('emp_gall_lab', esc_html__('Employer Gallery:', 'nokri')); ?></h3>
