            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="n-candidate-info">
                    ...
                    <div class="n-candidate-meta-box">                    
                        ...
                        } if ($soc_sec && $social_links && $cand_profile_status == 'pub' || $author_id == $current_user_id || $is_search) {
                            ?>
    ...
    <div class="container">
        <div class="row">
            ...
            if ($cand_profile_status == 'pub' || $author_id == $current_user_id || current_user_can('administrator') || $is_search) {
                    ...
                    <aside class="resume-3-sidebar">
                        <div class="n-candidate-info">
                            ...
                            <ul>
                                ...
                                } if (( $is_public & $cand_phone != "") || $author_id == $current_user_id) {
                            ...
                            <?php if ($cand_save_setting) { ?>
                                ...
                                <button type="submit" class="btn n-btn-custom btn-block saving_resume test mb-2 w-100" data-cand-id= <?php echo esc_attr($author_id); ?>><i class="fa fa-heart"></i><?php echo nokri_feilds_label('cand_save_resume', esc_html__('Save Resume', 'nokri')); ?></button>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 order-lg-2">
                                ...
                                <form id="contact_form_email" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <?php if ($nokri['google_recaptcha_key'] != "" && $contact_recaptcha) { ?>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">			
                                                <div class="g-recaptcha custom-recaptch-size mb-2" name="contact-recaptcha" data-sitekey="<?php echo esc_attr($nokri['google_recaptcha_key']); ?>">
                                                </div> 
                                            </div>        
                                        <?php } ?>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            if (!empty($cand_video)) {
                                ...
                                <div class="resume-3-box">
                                    ...
                                    <div class="portfolio-video">
                                        <iframe width="560" height="350" src="https://www.youtube.com/embed/<?php echo "" . esc_attr($cand_video); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <?php
                            }
							  ...
							  ^(?:https?://)?                           # Optional protocol
							   ...
							   ([^&]{11})                               # Video id of 11 characters as capture group 1
                                ...
                                <div class="resume-3-box">
                                    ...
                                    <div class="portfolio-video">
                                        <iframe width="560" height="350" src="https://www.youtube.com/embed/<?php echo "" . esc_attr($cand_intro_video); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                                <?php
                            }
