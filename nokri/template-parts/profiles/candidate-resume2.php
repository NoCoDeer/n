...
<section class="n-breadcrumb-big" <?php echo '' . nokri_returnEcho($bg_url); ?>>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="breadcrumb-text">
                    ...
                    <ul>
                        ...
                        <li><?php echo esc_html(nokri_breadcrumb()); ?></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="n-candidate-detail abc">
    <div class="container">
        <div class="row">
            <?php
            if ($cand_profile_status == 'pub' || $author_id == $current_user_id || current_user_can('administrator') || $is_search) {
                ...
                ?>
                <div class="col-lg-3 col-md-12 col-sm-12 order-lg-4 order-md-3">
                            ...
                            <div class="dingle-job-company-meta">
                                <?php if ($soc_sec && $social_links || $author_id == $current_user_id && $cand_profile_status == 'pub') { ?>
                                    <ul class="social-links">
                                        <?php if ($cand_fb) { ?>
                                            <li><a href="<?php echo esc_url($cand_fb); ?>"><img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/006-facebook.png'); ?>" class="img-responsive" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"></a></li>
                                        <?php } if ($cand_google) { ?>
                                            <li>
                                                <a href="<?php echo esc_url($cand_google); ?>">
                                                    <img src="<?php echo esc_url(get_template_directory_uri().'/images/icons/003-google-plus.png');?>" class="img-responsive" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                                </a>
                                            </li>
                                        <?php } if ($cand_twiter) { ?>
                                            <li>
                                                <a href="<?php echo esc_url($cand_twiter); ?>">
                                                    <img src="<?php echo esc_url(get_template_directory_uri().'/images/icons/004-twitter.png');?>" class="img-responsive" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                                </a>
                                            </li>
                                        <?php } if ($cand_linked) { ?>
                                            <li>
                                                <a href="<?php echo esc_url($cand_linked); ?>">
                                                    <img src="<?php echo esc_url(get_template_directory_uri().'/images/icons/005-linkedin.png');?>" class="img-responsive" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                                </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                ...
                                <?php if ($cand_save_setting) { ?>
                                    <button type="submit" class="btn n-btn-custom btn-block saving_resume mb-2 w-100" data-cand-id= <?php echo esc_attr($author_id); ?>><i class="fa fa-heart"></i><?php echo nokri_feilds_label('cand_save_resume', esc_html__('Save Resume', 'nokri')); ?></button> 
                        ...
                        <div class="n-candidate-info">
                            ...
                            <ul>
                                <?php if ($cand_dob && nokri_feilds_operat('cand_dob_setting', 'show') && $cand_dob_setting) { ?>
                                    <li>
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/017-birthday.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"> 
                                ...
                                <?php } if ($registered) { ?>
                                    <li>
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/011-calendar.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"> 
                                    ...
                                    <?php
                                } if (($cand_phone != "" && $is_public) || $author_id == $current_user_id) {
                                    if ($cand_phone_setting) {
                                        ?>
                                        <li>
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/009-phone-receiver.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"> 
                                    ...
                                    if ($cand_email_setting) {
                                        ?>
                                        <li>
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/008-email.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>"> 
                                    ...
                                    if ($cand_adress_setting) {
                                        ?>
                                        <li>
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/007-placeholder.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                    ...
                                    ?>
                                    <li>
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/coins.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                ...
                                <?php } if ($cand_gender && nokri_feilds_operat('cand_gend_setting', 'show')) { ?>
                                    <li>
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/gender.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                                ...
                                <?php } if ($cand_qualification && nokri_feilds_operat('cand_quali_setting', 'show')) { ?>
                                    <li>
                                        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/icons/resume-detail-icons/graduated.png'); ?>" alt="<?php echo esc_attr__('icon', 'nokri'); ?>">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 order-lg-3 order-md-4">
                    <div class="n-candidate-meta">
                        ...
                        <?php if ($cand_introd != '' && nokri_feilds_operat('cand_about_setting', 'show')) { ?>
                            <p><?php echo '' . wp_kses($cand_introd, get_allowed_html_tags()); ?></p>
                        ...
                        if (!empty($cand_intro_video) && !$cand_video_resume_switch) {
                            ...
                            <div class="resume-3-box">
                                ...
                                <div class="portfolio-video">
                                    <iframe width="750" height="380" src="https://www.youtube.com/embed/<?php echo "" . esc_attr($cand_intro_video); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                </div>
                            </div>
                            <?php
                        }
