...
/*Employer location on detail Page*/
$emp_loc = isset($nokri['employe_location_detail']) ? $nokri['employe_location_detail'] : false;

/*Jobs Limit on Details Page*/
 $jobs_limts = (isset($nokri['emp_jobs_show_on_detail']) ? $nokri['emp_jobs_show_on_detail'] : 3);
