...
<div class="blog-section"> 
 <div class="blog-heading">
    <h2><?php echo esc_html__( 'comment', 'nokri' )." ".( $comments_total ); ?></h2>
    <hr>
 </div>
			...
			<?php
                ...
                'fields' => apply_filters( 'comment_form_default_fields', array(
                        ...
                        'comment_field' => ' <div><div class="form-group"><label for="url">'
                            ...
                            '<div class=" class="col-md-12 col-sm-12""><div class="form-group mb-3"><textarea class="form-control" id="comment" name="comment" required cols="45" rows="7" aria-required="true" ></textarea></div></div> <!-- End col-sm-6 -->', 	
                    'comment_notes_after' => '',
                );
