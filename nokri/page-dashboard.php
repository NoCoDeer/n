                ...
                <form id="social_login_form" >
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="n-job-pages user-section">
                            <div class="col-md-8 col-sm-12 offset-md-2  offset-sm-2">
                                <div class="error-404">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <h3><?php echo esc_html__('Please Select Your Account Type', 'nokri'); ?></h3>

                                        <div class="btn-group" id="status" data-bs-toggle="buttons">
                                            ...
                                            <label class="btn btn-default btn-md active">
                                                <input type="radio" value="0" data-parsley-required="true" data-parsley-error-message="<?php echo esc_attr__('Please Select Type', 'nokri'); ?>" name="sb_reg_type" checked="checked">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="buttons-area">                                  
                                            <div class="form-group">
                                                <input type="checkbox" id="check_social_term"  name="icheck_box_terms" class="input-icheck-others" data-parsley-required="true" data-parsley-error-message="<?php echo esc_attr__('Please accept terms and conditions.', 'nokri'); ?>">
                                            ...
                                            <input type="submit" class="btn n-btn-flat btn-mid" id="social_login_btn" value="<?php echo esc_attr__('Continue', 'nokri'); ?>">
