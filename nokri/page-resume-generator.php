...
$user_id = filter_var($user_id, FILTER_SANITIZE_NUMBER_INT);  // Remove any non-numeric characters
...
$temp_id = filter_var($temp_id, FILTER_SANITIZE_NUMBER_INT);  // Remove any non-numeric characters
